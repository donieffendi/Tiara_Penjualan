                    ...
                    <form action="{{($tipx=='new')? url('/brg-jasa/store/') : url('/brg-jasa/update/'.$header->NO_ID ) }}" method="POST" name ="entri" id="entri" >
                        ...
                        <div class="tab-content mt-3">	
								...
								<div class="form-group row">
									...
									<div class="col-md-2">
										<input type="text" class="form-control KD_DEPT" id="KD_DEPT" name="KD_DEPT"
										placeholder="Masukkan Kode Suplier" value="{{$header->KD_DEPT}}">
									</div>    
									<div class="col-md-1">
								...
								<div class="form-group row">
									...
									<div class="col-md-4">
										...
										placeholder="Masukkan Nama Suplier" value="{{$header->DEPT}}">
									</div>                                                 
								</div>
