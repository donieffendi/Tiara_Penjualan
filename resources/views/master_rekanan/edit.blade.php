					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								...
								<form action="{{ $tipx == 'new' ? url('/rekanan/store/') : url('/rekanan/update/' . $header->NO_ID) }}" method="POST" name ="entri"
									id="entri">
									@csrf
									<div class="tab-content mt-3">
										...
										<div class="col-md-12 form-group row mt-3">
											<div class="col-md-4">
												<button type="button" hidden id='TOPX' onclick="location.href='{{ url('/rekanan/edit/?idx=' . $idx . '&tipx=top') }}'"
												...
												<button type="button" hidden id='BOTTOMX' onclick="location.href='{{ url('/rekanan/edit/?idx=' . $idx . '&tipx=bottom') }}'"
													class="btn btn-outline-primary">Bottom</button>
											</div>
											<div class="col-md-5">
												<button type="button" hidden id='NEWX' onclick="location.href='{{ url('/rekanan/edit/?idx=0&tipx=new') }}'"
													class="btn btn-warning">New</button>
												<button type="button" hidden id='EDITX' onclick='hidup()' class="btn btn-secondary">Edit</button>
												<button type="button" hidden id='UNDOX' onclick="location.href='{{ url('/rekanan/edit/?idx=' . $idx . '&tipx=undo') }}'"
											...
											<div class="col-md-3">
												...
												<button type="button" id='CLOSEX' onclick="location.href='{{ url('/rekanan') }}'" class="btn btn-outline-secondary">Close</button>
