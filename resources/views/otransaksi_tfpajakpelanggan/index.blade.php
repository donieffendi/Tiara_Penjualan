							...
							<div class="card-body">
								<div class="section-pink">
									...
									<form id="formBuatFaktur">
										@csrf
										<div class="mb-2">
											<label for="kitir"><strong>Kitir</strong></label>
											<input type="text" class="form-control form-control-sm" id="kitir" name="kitir" placeholder="Kitir">
										</div>
										<div class="mb-2">
											<label for="no_seri_pajak"><strong>No Seri Pajak</strong></label>
											<input type="text" class="form-control form-control-sm" id="no_seri_pajak" name="no_seri_pajak" placeholder="No Seri Pajak">
										</div>
										<div class="mb-2">
											<label for="nama_pelanggan"><strong>Nama Pelanggan</strong></label>
											<input type="text" class="form-control form-control-sm" id="nama_pelanggan" name="nama_pelanggan" placeholder="Nama Pelanggan">
										</div>
										<div class="mb-2">
											<label for="alamat_pelanggan"><strong>Alamat Pelanggan</strong></label>
											<input type="text" class="form-control form-control-sm" id="alamat_pelanggan" name="alamat_pelanggan" placeholder="Alamat Pelanggan">
										</div>
										<div class="mb-2">
											<label for="npwp"><strong>N. P. W. P</strong></label>
											<input type="text" class="form-control form-control-sm" id="npwp" name="npwp" placeholder="NPWP">
										</div>
										<div class="mt-3">
											<button type="button" class="btn btn-primary btn-sm btn-block" onclick="prosesFaktur()">
												Proses
											</button>
										</div>
									</form>
