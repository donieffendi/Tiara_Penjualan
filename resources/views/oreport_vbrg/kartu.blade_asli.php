                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
						<div class="col-md-2">							
							...
							<input type="text" class="form-control vbrg" id="vbrg" name="vbrg" placeholder="Pilih Barang" value="{{ session()->get('filter_brg1') }}" readonly>
						</div>  
						...
						<div class="col-md-2">						
							...
							<input type="text" class="form-control vbrg2" id="vbrg2" name="vbrg2" placeholder="ZZZ" value="{{ session()->get('filter_brg2') }}" readonly>
						</div> 
					</div> 
