                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-md-3">
                                        ...
                                        <input type="date" class="form-control" id="tglDari"
                                            value="{{ date('Y-m-d') }}">
                                    </div>
                                    <div class="col-md-3">
                                        <label>Tanggal Sampai</label>
                                        <input type="date" class="form-control" id="tglSampai"
                                            value="{{ date('Y-m-d') }}">
                                    </div>
                                    <div class="col-md-3">
...
@section('javascripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#btnPrintGayan').on('click', function() {
                cetakPdf();
            });
        });
        ...
        function tampilkanTabel(data, tipePromo, jenisLap) {
            ...
            var html =
                '<div class="table-responsive"><table id="tblData" class="table table-bordered table-striped"><thead><tr>';
        ...
        //     function cetakPdf() {
        //     let jenisLap   = $('#jenisLap').val();
        //     let tipePromo  = $('#tipePromo').val();
        //     let cbgMa      = $('#cbgMa').val();
        //     let tglDari    = $('#tglDari').val();
        //     let tglSampai  = $('#tglSampai').val();
        //     let reportName = $('#reportName').val();

        //     $.ajax({
        //         url: "{{ route('rpromoGayan.cetakpdf') }}",
        //         type: "GET",
        //         data: {
        //             jenisLap: jenisLap,
        //             tipePromo: tipePromo,
        ...
        //                 icon: 'error',
        //                 title: 'Gagal',
        //                 text: xhr.responseJSON?.message || 'Terjadi kesalahan saat mencetak PDF.',
        //             });
        //         }
        //     });
        // }
        function cetakPdf() {
            ...
            let base = "{{ route('rpromoGayan.cetakpdf') }}";

            for (let file = 0; file < 2; file++) { // buka 2 PDF
                let params = new URLSearchParams({
                    jenisLap: JENIS_LAP,
                    tipePromo: $('#cbPromo').val(),
                    cbgMa: CBG_MA,
                    tglDari: $('#tglDari').val(),
                    tglSampai: $('#tglSampai').val(),
                    reportName: $('#reportName').val(),
                    file: file // <<--- kirim index file ke Laravel
                });
