							...
							<div class="form-section">
								<div class="row">
									<div class="col-md-12 text-right">
										...
										<a target="_blank" href="{{url('tlphffmingguan/cetak')}}">
			...
			columns: [{
				...
				},
				{
					...
					render: function(data, type, row) {
						if (CBG == 'TMM') return formatNumber(row.LPH_TMM_LH, 2);
						if (CBG == 'SOP') return formatNumber(row.LPH_KG_LH, 2);
						return formatNumber(row.LPH_GZ_LH, 2);
					},
					className: 'text-right'
				},
				{
					data: null,
					render: function(data, type, row) {
						if (CBG == 'TMM') return formatNumber(row.LPH_TMM, 2);
						if (CBG == 'SOP') return formatNumber(row.LPH_KG, 2);
						return formatNumber(row.LPH_GZ, 2);
					},
					className: 'text-right'
				},
				{
				...
				},
				{
					data: null,
					render: function(data, type, row) {
						if (CBG == 'TMM') return row.JLMM;
						if (CBG == 'SOP') return row.JLKG;
						return row.JLGZ;
					},
					className: 'text-right'
				},
				{
					data: null,
					render: function(data, type, row) {
						if (CBG == 'TMM') return row.TS_MM;
						if (CBG == 'SOP') return row.TS_KG;
						return row.TS_GZ;
					},
					className: 'text-right'
				},
				{
					data: null,
					render: function(data, type, row) {
						if (CBG == 'TMM') return row.KSG_TMM;
						if (CBG == 'SOP') return row.KSG_KG;
						return row.KSG_GZ;
					},
					className: 'text-right'
				},
