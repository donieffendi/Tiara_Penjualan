					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Stok Opname Koreksi Manual</h3>
							</div>
							<div class="card-body">
	...
	<script>
		$(document).ready(function() {
			var dataTable = $('.datatable').DataTable({
				...
				ajax: {
					url: '{{ route('phsokoreksimanual.get-data') }}'
				},
				columns: [{
						data: 'DT_RowIndex',
						name: 'DT_RowIndex',
			...
			$("div.test_btn").html(
				'<a class="btn btn-success" href="{{ route('phsokoreksimanual.create') }}" title="Tambah Data"><i class="fas fa-plus"></i> New</a>'
			);
		...
		function editData(no_bukti) {
			window.location.href = '{{ route('phsokoreksimanual') }}?no_bukti=' + no_bukti + '&status=edit';
		}
