	...
	<div class="content-wrapper">
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0">Laporan Selisih Stock Opname</h1>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item active">Laporan Selisih Stock Opname</li>
						</ol>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<!-- Filter Section -->
								<form method="GET" action="{{ route('get-selisihso-report') }}" id="macetForm">
									@csrf
										...
										<div class="row mb-3">
											<div class="col-12">
												<div class="alert alert-info">
													...
													Dari Tanggal: {{ session()->get('filter_tglDari') }} | 
													Sampai Tanggal: {{ session()->get('filter_tglSampai') }} 
												</div>
											</div>
										</div>
									@endif
								...
								<div class="report-content">
									@if ($selisihSO && count($selisihSO) > 0)
										<?php
										\koolreport\datagrid\DataTables::create([
										    'dataSource' => $selisihSO,
										    ...
										    'options' => [
										        'columnDefs' => [
										            [
										                'className' => 'dt-right',
										                'targets' => [8,9,10], // numeric columns
										            ],
										            [
										                'className' => 'dt-center',
										                'targets' => [0,1,2,3,4,5,6,7,11,12], // center aligned columns
										            ],
										        ],
										        'paging' => true,
										        'pageLength' => 25,
									...
									@else
										<div class="alert alert-info text-center">
											...
											Silakan pilih cabang dan tanggal untuk menampilkan data SO.
										</div>
									@endif
								</div>
							</div>
...
@section('javascripts')
	<script>
		...
		// Reset form function
		function resetForm() {
			window.location.href = '{{ route('rselisihso') }}';
		}
