...
<div class="content-wrapper">
	...
	<div class="container-fluid">
		<div class="row mb-2">
		<div class="col-sm-6">
			<h1 class="m-0">Laporan Penambahan Barang Hadiah</h1>
		</div>
		<div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
				<li class="breadcrumb-item active">Laporan Penambahan Barang Hadiah</li>
			</ol>
		</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="card">
				<div class="card-body">
					...
					<form method="POST" action="{{url('jasper-hdh-report-tambah')}}">
					@csrf
