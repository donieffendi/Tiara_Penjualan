		...
		<div class="row">
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="form-group row">
						<div class="col-md-2">
							<label><strong>POSTED</strong></label>
							<select name="posted" id="posted" class="form-control posted" style="width: 200px">
								<option value="">--Pilih Posted--</option>
                                <option value="0">BELUM DIPOSTED</option>
								<option value="1">SUDAH DIPOSTED</option>
							</select>
						</div>
					</div>
