						...
						<div class="card">
							<div class="card-body">
								<div class="info-box">
									...
									<strong>Informasi:</strong> Masukkan Kode Barang untuk mencari data barang. Tekan Enter atau klik tombol Tampilkan untuk
									melakukan pencarian.
								</div>
										...
										<div class="row">
											<div class="col-md-10">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="kd_brg" name="kd_brg" placeholder="Masukkan kode barang" autocomplete="off" autofocus>
												</div>
											</div>
											<div class="col-md-2">
												<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="supplier-box">
												<h6><i class="fas fa-truck"></i> <strong>Informasi Supplier</strong></h6>
												<table class="table-borderless detail-table table">
													<tr>
														<th style="width: 150px;">Nama Supplier</th>
														<td id="detail_nsup">-</td>
													</tr>
													<tr>
														<th>Kota</th>
...
@section('javascripts')
	...
	<script>
		$(document).ready(function() {
			console.log('=== HALAMAN DATA BARANG 1-1 DIMUAT ===');
		...
		function cariBarang() {
			...
			console.log('=== CARI BARANG ===');
			console.log('Kode Barang:', kd_brg);

			if (kd_brg === '') {
				console.warn('Kode barang kosong');
				Swal.fire({
					icon: 'warning',
					title: 'Perhatian',
		...
		function tampilkanDetail(data) {
			...
			console.log('Detail Transaksi:', detail_transaksi);
			...
			// Isi data supplier
			$('#detail_nsup').text(supplier.nama || '-');
			$('#detail_kota').text(supplier.kota || '-');
			$('#detail_alamat').text(supplier.alamat || '-');
