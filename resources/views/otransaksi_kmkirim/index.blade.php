                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="columnToggleForm">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                            value="4" id="columnUsrnm" checked>
                                        <label class="form-check-label" for="columnUsrnm">Username</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="columnPost">Posting</label>
                                    </div>
                                </form>
                            </div>
                ...
                <table class="table table-fixed table-striped table-border table-hover nowrap datatable" id="datatable">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th scope="col" style="text-align: left">Posting</th>
                        </tr>
                    </thead>
...
<script>
  ...
  $(document).ready(function() {
        ...
        $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('kmkirim/edit?flagz='.$flagz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a');
        ...
        window.toggleButton = function(button) {
            ...
            if (button.innerText === '+') {
                ...
                $.ajax({
                    url: '{{ route('get-detail-kmkirim') }}', // Define the route to fetch detail data
                    method: 'GET',
                    data: {
                        no_bukti: no_bukti
                        ...
                        response.forEach((item, index) => {
                            ...
                            detailHtml += `
                                <tr>
                                    ...
                                    <td><div style="background-color: #f7d8b4; padding: 0.5rem;">${item.NO_KIRIM}</div></td>
                                    <td><div style="background-color: #f7d8b4; padding: 0.5rem;">${item.CBG_TUJU}</div></td>
                            `;
                        });
