        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <input name="flagz"  class="form-control flagz" id="flagz" value="HS" hidden >
              <input name="golz"  class="form-control golz" id="golz" value="HS" hidden >
