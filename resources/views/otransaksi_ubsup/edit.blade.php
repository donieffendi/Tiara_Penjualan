                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="{{($tipx=='new')? url('/ubsup/store?flagz='.$flagz.'&golz='.$golz.'') : url('/ubsup/update/'.$header->NO_ID.'&flagz='.$flagz.'&golz='.$golz.'' ) }}" method="POST" name ="entri" id="entri" >
                                                    ...
                                                    <thead class="text-center">
                                                        <tr>
                                                            ...
                                                            <th style="width: 120px; white-space: nowrap;">
                                                                ...
                                                                <label for="KD_BRG" class="form-label">Kode Supplier</label>
                                                            </th>
                                                            <th style="width: 550px;text-align: center;white-space: nowrap;">Nama Supplier</th>
                                                            <th {{ ($flagz == 'HS') ? 'hidden' : '' }}
                                                                style="width: 550px; white-space: nowrap;">Email
                                                            </th>
                                                            <th {{ ($flagz == 'HS') ? 'hidden' : '' }}
                                                                style="width: 550px; white-space: nowrap;">Email Baru
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($detail as $detail)
                                                            <tr>
                                                                ...
                                                                <td {{ ($flagz == 'HS') ? 'hidden' : '' }}>
                                                                    <input name="EMAIL[]" id="EMAIL{{ $no }}"
                                                                        type="text" value="{{ $detail->EMAIL }}"
                                                                        class="form-control EMAIL" required>
                                                                </td>


                                                                <td {{ ($flagz == 'HS') ? 'hidden' : '' }}>
                                                                    <input name="E_BARU[]" id="E_BARU{{ $no }}"
                                                                        type="text" class="form-control E_BARU"
                                                                        value="{{ $detail->E_BARU }}" required>
                                                                </td>
                                    ...
                                    <div class="mt-3 col-md-12 form-group row">
                                        <div class="col-md-4">
                                            <button hidden type="button" id='TOPX'
                                                onclick="location.href='{{ url('/ubsup/edit/?idx=' . $idx . '&tipx=top&flagz=' . $flagz . '') }}'"
                                                class="btn btn-outline-primary">Top</button>
                                            <button hidden type="button" id='PREVX'
                                                onclick="location.href='{{ url('/ubsup/edit/?idx=' . $header->NO_ID . '&tipx=prev&flagz=' . $flagz . '&buktix=' . $header->NO_BUKTI) }}'"
                                                class="btn btn-outline-primary">Prev</button>
                                            <button hidden type="button" id='NEXTX'
                                                onclick="location.href='{{ url('/ubsup/edit/?idx=' . $header->NO_ID . '&tipx=next&flagz=' . $flagz . '&buktix=' . $header->NO_BUKTI) }}'"
                                                class="btn btn-outline-primary">Next</button>
                                            <button hidden type="button" id='BOTTOMX'
                                                onclick="location.href='{{ url('/ubsup/edit/?idx=' . $idx . '&tipx=bottom&flagz=' . $flagz . '') }}'"
                                                class="btn btn-outline-primary">Bottom</button>
                                        </div>
                                        <div class="col-md-5">
                                            <button hidden type="button" id='NEWX'
                                                onclick="location.href='{{ url('/ubsup/edit/?idx=0&tipx=new&flagz=' . $flagz . '') }}'"
                                            ...
                                            <button hidden type="button" id='UNDOX'
                                                onclick="location.href='{{ url('/ubsup/edit/?idx=' . $idx . '&tipx=undo&flagz=' . $flagz . '') }}'"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <!-- <button type="button" id='CLOSEX'  onclick="location.href='{{ url('/ubsup?flagz=' . $flagz . '') }}'" class="btn btn-outline-secondary">Close</button> -->
    ...
    @section('footer-scripts')
        ...
        <script>
            ...
            $(document).ready(function() {
                    ...
                    $.ajax({
...

                        {
                            ...
                            if (resp.length > 1) {
                                ...
                                $("#KOTA" + rowidBarang).val(resp[0].EMAIL);
                            }
                        }
                    });
                }
                ...
                chooseBarang = function(KODES, NAMAS, EMAIL) {
                    $("#KODES" + rowidBarang).val(KODES);
                    $("#NAMAS" + rowidBarang).val(NAMAS);
                    $("#EMAIL" + rowidBarang).val(EMAIL);
		...
		var golz = "{{ $golz }}";
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Swal.fire({
                            ...
                            loc = "{{ url('/ubsup/delete/' . $header->NO_ID) }}" + '?flagz=' +
                                encodeURIComponent(flagz) + '&golz=' + encodeURIComponent(golz);
            ...
            function closeTrans() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
	        	        loc = "{{ url('/ubsup/') }}" + '?flagz=' + encodeURIComponent(flagz) + '&golz=' + encodeURIComponent(golz) ;
                        window.location = loc;
                    } else {
                        Swal.fire({
                            icon: 'info',
            ...
            function CariBukti() {
                ...
                var golz = "{{ $golz }}";
		        var cari = $("#CARI").val();
		        var loc = "{{ url('/ubsup/edit/') }}" + '?idx={{ $header->NO_ID}}&tipx=search&flagz=' + encodeURIComponent(flagz) + '&golz=' + encodeURIComponent(golz) + '&buktix=' +encodeURIComponent(cari);
                window.location = loc;
            ...
            function tambah() {
                ...
                <td {{ ($flagz == 'HS') ? 'hidden' : '' }}>
				    <input name='EMAIL[]'   id='EMAIL${idrow}' type='text' class='form-control  EMAIL' required readonly>
                </td>
                <td {{ ($flagz == 'HS') ? 'hidden' : '' }}>
                    <input name="E_BARU[]" id="E_BARU${idrow}" type="text" class="form-control" required>
                </td>
