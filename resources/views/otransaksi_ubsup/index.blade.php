...
<script>
  ...
  $(document).ready(function() {
        ...
        $("div.test_btn").html(
        '<a class="btn btn-lg btn-md btn-success" href="{{url('ubsup/edit?flagz='.$flagz.'&golz='.$golz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a> ');
