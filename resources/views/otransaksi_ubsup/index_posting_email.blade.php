        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <form method="POST" id="entri" action="{{url('ubsup/posting')}}">

              <input name="flagz"  class="form-control flagz" id="flagz" value="UE" hidden >
              <input name="golz"  class="form-control golz" id="golz" value="UE" hidden >
  ...
  $(document).ready(function() {
        ...
        window.toggleButton = function(button) {
            ...
            if (button.innerText === '+') {
                ...
                $.ajax({
                    url: '{{ route('get-detail-ubsup') }}', // Define the route to fetch detail data
                    method: 'GET',
                    data: {
                        no_bukti: no_bukti
