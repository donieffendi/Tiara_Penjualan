                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form
                                    action="{{ $tipx == 'new' ? url('/ubsup/store?flagz=' . $flagz . '') : url('/ubsup/update/' . $header->NO_ID . '&flagz=' . $flagz . '') }}"
        ...
        <script>
            ...
            function closeTrans() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        loc = "{{ url('/ubsup/') }}" + '?flagz=' + encodeURIComponent(flagz);
                        window.location = loc;
                    } else {
                        Swal.fire({
                            icon: 'info',
            ...
            function CariBukti() {
                ...
                var flagz = "{{ $flagz }}";
                var cari = $("#CARI").val();
                var loc = "{{ url('/ubsup/edit/') }}" + '?idx={{ $header->NO_ID }}&tipx=search&flagz=' + encodeURIComponent(
