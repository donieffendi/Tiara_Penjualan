											...
											<div class="pt-3">
												...
												<div class="row align-items-end mb-3">
													...
													<div class="col-2">
														...
														<input type="text" name="kode_sampai" id="kode_sampai" class="form-control" placeholder="Kode Akhir"
...
@section('javascripts')
	<script>
		...
		function filterCard() {
			...
			window.location.href = '{{ route('get-hadiah-report') }}?' +
				'type=card' +
				...
				'&kode_dari=' + encodeURIComponent(kodeDari) +
				'&kode_sampai=' + encodeURIComponent(kodeSampai);
		}
				...
				success: function(response) {
					if (response.length > 0) {
						...
						$.each(response, function(i, item) {
							...
							html += '<td class="text-right">' + formatNumber(item.lain2 || 0) + '</td>';
