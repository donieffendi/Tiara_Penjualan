              ...
              <!-- filter kolom di index -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-1">
                        ...
                        <form method="POST" id="postingForm" action="{{ url('posting_byr_hutang/') }}">
                            @csrf
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="columnToggleForm">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                            value="7" id="columnKota" checked>
                                        <label class="form-check-label" for="columnKota">Kota</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                            value="8" id="columnBayar" checked>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                            value="10" id="columnPost" checked>
