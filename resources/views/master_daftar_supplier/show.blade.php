...
@section('content')
	<style>
		...
		.form-group.special-input-label input[readonly] {
			background-color: #f5f5f5 !important;
		}
	</style>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								...
								<form method="POST" name ="entri" id="entri">
									...
									<div class="tab-content mt-3">
										...
										<div class="form-group row">
											...
											<div class="col-md-2 form-group row special-input-label">
												<input type="text" class="GOLONGAN" id="GOLONGAN" name="GOLONGAN" value="{{ $header->GOLONGAN }}" placeholder=" " readonly>
													...
													<div class="tab-content mt-3">
														...
														<div class="tab-pane show active" id="main">
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="PEMILIK" id="PEMILIK" name="PEMILIK" value="{{ $header->PEMILIK }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="TLP_R" id="TLP_R" name="TLP_R" value="{{ $header->TLP_R }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="ALMT_R" id="ALMT_R" name="ALMT_R" value="{{ $header->ALMT_R }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-3 form-group row special-input-label">
																	<input type="text" class="ALMT_K" id="ALMT_K" name="ALMT_K" value="{{ $header->ALMT_K }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="KOTA" id="KOTA" name="KOTA" value="{{ $header->KOTA }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="ALMT_GD" id="ALMT_GD" name="ALMT_GD" value="{{ $header->ALMT_GD }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="TLP_K" id="TLP_K" name="TLP_K" value="{{ $header->TLP_K }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="NO_FAX" id="NO_FAX" name="NO_FAX" value="{{ $header->NO_FAX }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="NO_HP" id="NO_HP" name="NO_HP" value="{{ $header->NO_HP }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="NO_TELEX" id="NO_TELEX" name="NO_TELEX" value="{{ $header->NO_TELEX }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="EMAIL" id="EMAIL" name="EMAIL" value="{{ $header->EMAIL }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="EMAIL2" id="EMAIL2" name="EMAIL2" value="{{ $header->EMAIL2 }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="EMAIL3" id="EMAIL3" name="EMAIL3" value="{{ $header->EMAIL3 }}" placeholder=" ">
															...
															<div class="form-group row">
																...
																<div class="col-md-1 form-group row special-input-label">
																	<input type="text" class="GOL_BRG" id="GOL_BRG" name="GOL_BRG" value="{{ $header->GOL_BRG }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-1 form-group row special-input-label">
																	<input type="text" class="KD_PEMBY" id="KD_PEMBY" name="KD_PEMBY" value="{{ $header->KD_PEMBY }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="STM_PEMBL" id="STM_PEMBL" name="STM_PEMBL" value="{{ $header->STM_PEMBL }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-1 form-group row special-input-label">
																	<input type="text" class="DISC_PS" id="DISC_PS" name="DISC_PS" value="{{ $header->DISC_PS }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="JEN_BRG1" id="JEN_BRG1" name="JEN_BRG1" value="{{ $header->JEN_BRG1 }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="CARA" id="CARA" name="CARA" value="{{ $header->CARA }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-1 form-group row special-input-label">
																	<input type="text" class="BG_PERS" id="BG_PERS" name="BG_PERS" value="{{ $header->BG_PERS }}" placeholder=" ">
															...
															<div class="form-group row">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="STTS" id="STTS" name="STTS" value="{{ $header->STTS }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-1 form-group row special-input-label">
																	<input type="text" class="SUB" id="SUB" name="SUB" value="{{ $header->SUB }}" placeholder=" ">
														...
														<div class="tab-pane show" id="bankinfo">
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="KD_BANK" id="KD_BANK" name="KD_BANK" value="{{ $header->KD_BANK }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="NPWP" id="NPWP" name="NPWP" value="{{ $header->NPWP }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="NPPKP" id="NPPKP" name="NPPKP" value="{{ $header->NPPKP }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="NAMA_B" id="NAMA_B" name="NAMA_B" value="{{ $header->NAMA_B }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="NM_NPWP" id="NM_NPWP" name="NM_NPWP" value="{{ $header->NM_NPWP }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="CABANG_B" id="CABANG_B" name="CABANG_B" value="{{ $header->CABANG_B }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="NO_NPWP" id="NO_NPWP" name="NO_NPWP" value="{{ $header->NO_NPWP }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="KOTA_B" id="KOTA_B" name="KOTA_B" value="{{ $header->KOTA_B }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="AL_NPWP" id="AL_NPWP" name="AL_NPWP" value="{{ $header->AL_NPWP }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="AN_B" id="AN_B" name="AN_B" value="{{ $header->AN_B }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="NOREK" id="NOREK" name="NOREK" value="{{ $header->NOREK }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input class="date" id="TG_NPWP" name="TG_NPWP" data-date-format="dd-mm-yyyy" type="text" autocomplete="off"
																		value="{{ date('d-m-Y', strtotime($header->TG_NPWP)) }}">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="SERI" id="SERI" name="SERI" value="{{ $header->SERI }}" placeholder=" ">
													...
													<div class="tab-content mt-3">
														...
														<div class="tab-pane show active" id="main2">
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="KETHAP" id="KET_HAPUS" name="KET_HAPUS" value="{{ $header->KET_HAPUS }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="JMN_RETUR" id="JMN_RETUR" name="JMN_RETUR" value="{{ $header->JMN_RETUR }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="HARI" id="HARI" name="HARI" value="{{ $header->HARI }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="TND_SPL" id="TND_SPL" name="TND_SPL" value="{{ $header->TND_SPL }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="B_CODE" id="B_CODE" name="B_CODE" value="{{ $header->B_CODE }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="JAMIN_RET" id="JAMIN_RET" name="JAMIN_RET" value="{{ $header->JAMIN_RET }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="VA_GZ" id="VA_GZ" name="VA_GZ" value="{{ $header->VA_GZ }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="S_BAR" id="S_BAR" name="S_BAR" value="{{ $header->S_BAR }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="NOREK_GZ" id="NOREK_GZ" name="NOREK_GZ" value="{{ $header->NOREK_GZ }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="AN_B_GZ" id="AN_B_GZ" name="AN_B_GZ" value="{{ $header->AN_B_GZ }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="ANB_VA_GZ" id="ANB_VA_GZ" name="ANB_VA_GZ" value="{{ $header->ANB_VA_GZ }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="EMAIL_GZ" id="EMAIL_GZ" name="EMAIL_GZ" value="{{ $header->EMAIL_GZ }}" placeholder=" ">
														...
														<div class="tab-pane show" id="uraian">
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="D_BUTOR" id="D_BUTOR" name="D_BUTOR" value="{{ $header->D_BUTOR }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="CAT_RET" id="CAT_RET" name="CAT_RET" value="{{ $header->CAT_RET }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="CAT_PRM" id="CAT_PRM" name="CAT_PRM" value="{{ $header->CAT_PRM }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="SR_TERBIT" id="SR_TERBIT" name="SR_TERBIT" value="{{ $header->SR_TERBIT }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="BONAFIT" id="BONAFIT" name="BONAFIT" value="{{ $header->BONAFIT }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="KEL_PAJAK" id="KEL_PAJAK" name="KEL_PAJAK" value="{{ $header->KEL_PAJAK }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="N_AKTIF" id="N_AKTIF" name="N_AKTIF" value="{{ $header->N_AKTIF }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="KETNAKTIF" id="KETNAKTIF" name="KETNAKTIF" value="{{ $header->KETNAKTIF }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="LAIN1" id="LAIN1" name="LAIN1" value="{{ $header->LAIN1 }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="KD_MIN" id="KOD_MIN" name="KOD_MIN" value="{{ $header->KOD_MIN }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="KLB2" id="KLB2" name="KLB2" value="{{ $header->KLB2 }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="LAIN2" id="LAIN2" name="LAIN2" value="{{ $header->LAIN2 }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="ORDR" id="ORDR" name="ORDR" value="{{ $header->ORDR }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="BY_KR" id="BY_KR" name="BY_KR" value="{{ $header->BY_KR }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="URAIAN1" id="URAIAN1" name="URAIAN1" value="{{ $header->URAIAN1 }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="SUP_BARU" id="SUP_BARU" name="SUP_BARU" value="{{ $header->SUP_BARU }}" placeholder=" ">
																	<label for="SUP_BARU">Sup Baru</label>
																</div>
																<!-- tutupannya -->
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="JAM" id="JAM" name="JAM" value="{{ $header->JAM }}" placeholder=" ">
															...
															<div class="form-group row">
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="URAIAN2" id="URAIAN2" name="URAIAN2" value="{{ $header->URAIAN2 }}" placeholder=" ">
																...
																<!-- code text box baru -->
																<div class="col-md-2 form-group row special-input-label">
																	<input type="text" class="KLK" id="KLK" name="KLK" value="{{ $header->KLK }}" placeholder=" ">
															...
															<div class="form-group row">
																...
																<!-- code text box baru -->
																<div class="col-md-5 form-group row special-input-label">
																	<input type="text" class="CAT_SP" id="CAT_SP" name="CAT_SP" value="{{ $header->CAT_SP }}" placeholder=" ">
									...
									<div class="col-md-12 form-group row mt-3">
										<div class="col-md-4">
											<button type="button" id='TOPX' onclick="location.href='{{ url('/sup/show/?idx=' . $idx . '&tipx=top') }}'"
												class="btn btn-outline-primary">Top</button>
											<button type="button" id='PREVX'
												onclick="location.href='{{ url('/sup/show/?idx=' . $header->NO_ID . '&tipx=prev&kodex=' . $header->KODES) }}'"
												class="btn btn-outline-primary">Prev</button>
											<button type="button" id='NEXTX'
												onclick="location.href='{{ url('/sup/show/?idx=' . $header->NO_ID . '&tipx=next&kodex=' . $header->KODES) }}'"
												class="btn btn-outline-primary">Next</button>
											<button type="button" id='BOTTOMX' onclick="location.href='{{ url('/sup/show/?idx=' . $idx . '&tipx=bottom') }}'"
...
@section('footer-scripts')
	...
	<script>
		...
		$(document).ready(function() {
			...
			$('input, textarea').not('[type="button"], [type="submit"], #tipx, #NO_ID').prop('readonly', true);
		...
		function hidup() {
			...
			// Mode show - tidak perlu hidup, tetap readonly
		...
		function mati() {
			...
			// Mode show - hanya enable navigation dan close
			$("#TOPX").attr("disabled", false);
			$("#PREVX").attr("disabled", false);
			$("#NEXTX").attr("disabled", false);
			$("#BOTTOMX").attr("disabled", false);
		...
		function CariBukti() {
			...
			var cari = $("#CARI").val();
			var loc = "{{ url('/sup/show/') }}" + '?idx={{ $header->NO_ID }}&tipx=search&kodex=' + encodeURIComponent(cari);
			window.location = loc;
