...
<script>
  $(document).ready(function() {
        ...
        $("div.test_btn").html(`<a class="btn btn-lg btn-md btn-success" href="{{url('sup/edit?idx=0&tipx=new')}}">
        ...
        $('#btnPrint').on('click', function() {
          ...
          Swal.fire({
              ...
              if (result.isConfirmed) {
                  ...
                  window.open(`{{ url('sup/cetak') }}?search=${encodeURIComponent(searchValue)}`, '_blank');
              }
          });
        });
    });
