                                            ...
                                            <table id="datatable" class="table table-striped table-border">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th <?php echo $flagz == 'KB' ? '' : 'hidden'; ?> style="text-align: center;">Qty-Comp</th>
                                                        <th <?php echo $flagz == 'KB' ? '' : 'hidden'; ?> style="text-align: center;">Qty Selisih</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($detail as $detail)
                                                        <tr>
                                                            ...
                                                            <td><input name="QTY[]" onclick="select()"
