										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<form id="columnToggleForm">
													...
													<div class="form-check">
														<input class="form-check-input column-checkbox" type="checkbox" value="8" id="columnSisa" checked>
														<label class="form-check-label" for="columnSisa">Sisa</label>
													</div>
													<div class="form-check">
														<input class="form-check-input column-checkbox" type="checkbox" value="9" id="columnStatus" checked>
...
@section('javascripts')
	...
	<script>
		...
		$(document).ready(function() {
			...
			$("div.test_btn").html(
				'<a class="btn btn-success" href="{{ url('tpenagihansewa/edit?idx=0&tipx=new') }}" title="Tambah Data"><i class="fas fa-plus"></i> Tambah</a>'
			);
		});
