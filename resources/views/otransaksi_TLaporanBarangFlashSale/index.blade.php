                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="info-section">
                                    ...
                                    Laporan ini menampilkan data barang flash sale yang perlu ditinjau. Klik tombol
                                    <strong>Proses Data</strong> untuk memuat ulang data terbaru
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        ...
                        return $.ajax({
                            ...
                            $('#LOADX').hide();
                            Swal.showValidationMessage('Proses gagal: ' + (xhr
                                .responseJSON?.error ||
                                'Terjadi kesalahan'));
                        });
                    },
            ...
            $('#btnPrint').on('click', function() {
                ...
                let form = $('<form>', {
                    action: "{{ route('laporanbarangflashsale_print') }}",
                    method: "POST",
                    target: "_blank"
                });
                    ...
                    error: function(xhr, error, code) {
                        ...
                        Swal.fire({
                            ...
                            html: '<div class="text-left">' +
                                ...
                                '<p class="text-danger">' + (xhr.responseJSON?.error || xhr.responseJSON
                                    ?.message ||
                                    'Gagal memuat data') + '</p>' +
                                '<hr>' +
