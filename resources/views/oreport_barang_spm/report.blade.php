                                ...
                                <form method="POST" action="{{ url('jasper-barangspm-report') }}" id="reportForm">
                                    ...
                                    <div class="form-group row align-items-end">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <button type="submit" class="btn btn-primary mb-2" name="filter">
                                                Data Barang
                                            </button>
                                    ...
                                    <ul class="nav nav-tabs" id="reportTabs" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" id="periode-tab" data-toggle="tab" href="#periode"
                                                role="tab" aria-controls="periode" aria-selected="true">
                                                <i class="fas fa-calendar mr-1"></i>Periode
                                            </a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="mutasi-tab" data-toggle="tab" href="#mutasi"
                                                role="tab" aria-controls="mutasi" aria-selected="false">
                                    ...
                                    <div class="tab-content" id="reportTabContent">
                                        <!-- Periode Tab -->
                                        <div class="tab-pane fade show active" id="periode" role="tabpanel"
                                                    ...
                                                    <div class="row align-items-end mb-3">
                                                        <div class="col-2">
                                                            ...
                                                            <select name="filter_type" id="filter_type"
                                                                class="form-control">
                                                                <option value="supp"
                                                                    {{ session()->get('filter_type') == 'supp' ? 'selected' : '' }}>
                                                                    Supp</option>
                                                                <option value="sub"
                                                                    {{ session()->get('filter_type') == 'sub' ? 'selected' : '' }}>
                                                                    Sub</option>
                                                                <option value="kd_brg"
                                                                    {{ session()->get('filter_type') == 'kd_brg' ? 'selected' : '' }}>
                                                                    Sub Item</option>
                                                                <option value="barcode"
                                                                    {{ session()->get('filter_type') == 'barcode' ? 'selected' : '' }}>
                                                                    Barcode</option>
                                                                <option value="na_brg"
                                                                    {{ session()->get('filter_type') == 'na_brg' ? 'selected' : '' }}>
                                                                    Nama Barang</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-3">
                                                            ...
                                                            <input type="text" name="filter_value" id="filter_value"
                                                                class="form-control"
                                                                value="{{ session()->get('filter_value') }}"
                                                                placeholder="Masukkan nilai pencarian dan tekan Enter..."
                                                                onkeypress="if(event.keyCode==13) filterBarang()">
                                                        </div>
                                                        <div class="col-2">
                                                            <label for="cbg_periode">Cabang</label>
                                                            <select name="cbg" id="cbg_periode" class="form-control"
                                                                required>
                                                        ...
                                                        <div class="col-3">
                                                            <button class="btn btn-primary mr-1" type="button"
                                                                id="btnFilterPeriode" onclick="filterBarang()">
                                        ...
                                        <div class="tab-pane fade" id="mutasi" role="tabpanel"
                                            aria-labelledby="mutasi-tab">
                                            <div class="pt-3">
                                                <div class="form-group">
                                                    <div class="row align-items-end mb-3">
                                                        <div class="col-2">
                                                            <label for="cbg_mutasi">Cabang</label>
                                                            <select name="cbg_mutasi" id="cbg_mutasi"
                                                                class="form-control">
                                                                <option value="">Pilih Cabang</option>
                                                                @foreach ($cbg as $cabang)
                                                                    <option value="{{ $cabang->CBG }}">
                                                        ...
                                                        {{-- <div class="col-2">
                                                            ...
                                                            <input type="text" name="periode_mutasi"
                                                                id="periode_mutasi" class="form-control"
                                                                placeholder="MM-YYYY" value="{{ date('m-Y') }}"
                                                                required>
                                                        </div> --}}
                                                        <div class="col-2">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="jenis_stock" id="stock_toko_mutasi"
                                                                    value="toko" checked>
                                                                <label class="form-check-label"
                                                                    for="stock_toko_mutasi">Toko</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="jenis_stock" id="stock_gudang_mutasi"
                                                                    value="gudang">
                                                                <label class="form-check-label"
                                                                    for="stock_gudang_mutasi">GD.Transit</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="jenis_stock" id="stock_retur_mutasi"
                                                                    value="retur">
                                                                <label class="form-check-label"
                                                                    for="stock_retur_mutasi">Retur</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-2">
                                                            <label for="sub_item">Sub Item</label>
                                                            <input type="text" name="sub_item" id="sub_item"
                                                                class="form-control" placeholder="Sub Item">
                                                        </div>
                                                        <div class="col-2">
                                                            <label for="kd_brg_mutasi">Kode Barang</label>
                                                            <input type="text" name="kd_brg_mutasi" id="kd_brg_mutasi"
                                                                class="form-control" placeholder="Kode Barang">
                                                        </div>
                                                        <div class="col-2">
                                                            <button class="btn btn-primary mr-1" type="button"
                                                                onclick="getKartuStock()">
                                                                <i class="fas fa-search mr-1"></i>Proses
                                                            </button>
                                                            <button class="btn btn-warning" type="button"
                                                                onclick="cetakKartuStock()">
                                                                <i class="fas fa-print mr-1"></i>Cetak
                                                            </button>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="report-content col-md-12" id="mutasi-result">
                                                        <div class="alert alert-info">
                                                            ...
                                                            Silakan pilih cabang, periode, jenis stock, dan kode barang
                                                            untuk menampilkan kartu mutasi.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
@section('javascripts')
    <script>
                ...
                success: function(response) {
                    if (response.length > 0) {
                        ...
                        $.each(response, function(i, item) {
                            ...
                            html += '<td class="text-right">' + formatNumber(item.KELUAR || 0) +
                                '</td>';
                            html += '<td class="text-right"><strong>' + formatNumber(item.SALDO || 0) +
                                '</strong></td>';
        ...
        function cetakKartuStock() {
            ...
            var url = '{{ url('jasper-barangspm-report') }}?cetak_kartu=1&cbg=' + cbg + '&periode=' + periode +
                '&kd_brg=' + kdBrg + '&jenis=' + jenis;
