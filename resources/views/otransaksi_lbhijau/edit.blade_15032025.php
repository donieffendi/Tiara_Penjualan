						...
						<div id="details" class="tab-pane active">
							...
							<form action="{{($tipx=='new')? url('/lbhijau/store?typez='.$typez.'') : url('/lbhijau/update/'.$header->NO_ID.'&typez='.$typez.'' ) }}" method="POST" name ="entri" id="entri" >
									...
									<table id="datatable" class="table table-striped table-border">
										...
										@foreach ($detail as $detail)		
											<tr>
												...
												<td>
													<input name="KD_BRG[]" id="KD_BRG{{$no}}" type="text" value="{{$detail->KD_BRG}}" class="form-control KD_BRG "  onblur="browseBarang({{$no}})" >
												</td>
												<td>
								...
								<div class="mt-3 col-md-12 form-group row">
									<div class="col-md-4">
										<button hidden type="button" id='TOPX'  onclick="location.href='{{url('/lbhijau/edit/?idx=' .$idx. '&tipx=top&typez='.$typez.'' )}}'" class="btn btn-outline-primary">Top</button>
										<button hidden type="button" id='PREVX' onclick="location.href='{{url('/lbhijau/edit/?idx='.$header->NO_ID.'&tipx=prev&typez='.$typez.'&buktix='.$header->NO_BUKTI )}}'" class="btn btn-outline-primary">Prev</button>
										<button hidden type="button" id='NEXTX' onclick="location.href='{{url('/lbhijau/edit/?idx='.$header->NO_ID.'&tipx=next&typez='.$typez.'&buktix='.$header->NO_BUKTI )}}'" class="btn btn-outline-primary">Next</button>
										<button hidden type="button" id='BOTTOMX' onclick="location.href='{{url('/lbhijau/edit/?idx=' .$idx. '&tipx=bottom&typez='.$typez.'' )}}'" class="btn btn-outline-primary">Bottom</button>
									</div>
									<div class="col-md-5">
										<button hidden type="button" id='NEWX' onclick="location.href='{{url('/lbhijau/edit/?idx=0&tipx=new&typez='.$typez.'' )}}'" class="btn btn-warning">New</button>
										<button hidden type="button" id='EDITX' onclick='hidup()' class="btn btn-secondary">Edit</button>                    
										<button hidden type="button" id='UNDOX' onclick="location.href='{{url('/lbhijau/edit/?idx=' .$idx. '&tipx=undo&typez='.$typez.'' )}}'" class="btn btn-info">Undo</button>  
								...
								<div class="tab-content mt-3">
									...
									<div class="form-group row">
										...
										<div class="col-md-2 form-group row special-input-label" hidden>
											<input type="text" class="KDBRGTAB2_ALL" id="KDBRGTAB2_ALL" name="KDBRGTAB2_ALL" 
												value="{{$header->BRG}}" placeholder=" ">
					...
					{	
							...
							for(i=0; i<resp.length; i++){
								...
								dTableBBarang.row.add([
									'<a href="javascript:void(0);" onclick="chooseBarang(\''+resp[i].KD_BRG+'\', \''+resp[i].NA_BRG+'\', \''+resp[i].KD_BRG2+'\'  )">'+resp[i].KD_BRG+'</a>',
									resp[i].NA_BRG,
								]);
							}
							dTableBBarang.draw();
