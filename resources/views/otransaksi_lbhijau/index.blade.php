        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <form method="POST" id="entri" action="{{url('lbhijau/posting')}}">
...
<script>
  ...
  $(document).ready(function() {
        ...
        $("div.test_btn").html(
        '<a class="btn btn-lg btn-md btn-success" href="{{url('lbhijau/edit?typez='.$typez.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a'
        );
        ...
        window.toggleButton = function(button) {
            ...
            if (button.innerText === '+') {
                ...
                $.ajax({
                    url: '{{ route('get-detail-lbhijau') }}', // Define the route to fetch detail data
                    method: 'GET',
                    data: {
                        no_bukti: no_bukti
