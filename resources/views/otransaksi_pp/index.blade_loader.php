        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <form method="POST" id="entri" action="{{url('pp/posting')}}">
...
<script>
  ...
  $(document).ready(function() {
        ...
        // // Menampilkan loader saat DataTable sedang memuat
        // $(document).on('preXhr.dt', function() {
        //     $('#OVERLAY').show(); // Tampilkan loader
        //     $('#LOADX').show(); // Tampilkan loader
        // });

        // // Menyembunyikan loader setelah DataTable selesai memuat data
        // $(document).on('xhr.dt', function() {
        //     $('#OVERLAY').show(); // Sembunyikan loader
        //     $('#LOADX').show(); // Sembunyikan loader
        // });
        ...
        $("div.test_btn").html(
        '<a class="btn btn-lg btn-md btn-success" href="{{url('pp/edit?flagz='.$flagz.'&golz='.$golz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a'
        );
        ...
        window.toggleButton = function(button) {
            ...
            if (button.innerText === '+') {
                ...
                $.ajax({
                    url: '{{ route('get-detail-pp') }}', // Define the route to fetch detail data
                    method: 'GET',
                    data: {
                        no_bukti: no_bukti
