        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <form method="POST" id="entri" action="{{url('ubhn/posting')}}">
...
<script>
  ...
  $(document).ready(function() {
        ...
        $("div.test_btn").html(
        '<a class="btn btn-lg btn-md btn-success" href="{{url('ubhn/edit?flagz='.$flagz.'&golz='.$golz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a> '+
        '<a class="btn btn-lg btn-md btn-warning  process-btn" href="{{url('ubhn/edit?flagz='.$flagz.'&golz='.$golz.'&idx=0&tipx=new')}}"> Proses </i></a>'
        );
        ...
        window.toggleButton = function(button) {
            ...
            if (button.innerText === '+') {
                ...
                $.ajax({
                    url: '{{ route('get-detail-ubhn') }}', // Define the route to fetch detail data
                    method: 'GET',
                    data: {
                        no_bukti: no_bukti
                        ...
                        response.forEach((item, index) => {
                            ...
                            detailHtml += `
                                <tr>
                                    ...
                                    <td><div style="background-color: #f7d8b4; padding: 0.5rem;">${item.NM_BRG}</div></td>
