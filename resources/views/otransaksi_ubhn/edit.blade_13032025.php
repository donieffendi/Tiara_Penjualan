...
@section('content')
                                                ...
                                                <table id="datatable" class="table table-striped table-bordered"
                                                    ...
                                                    <thead class="text-center">
                                                        <tr>
                                                            ...
                                                            <th style="width: 120px; white-space: nowrap;">Harga Penawaran</th>
                                                            ...
                                                            <th style="width: 120px; white-space: nowrap;">Perkiraan LPP</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($detail as $detail)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="ITEM_BR[]"
                                                                        id="ITEM_BR{{ $no }}" type="text"
                                                                        class="form-control ITEM_BR"
                                                                        value="{{ $detail->ITEM_BR }}" required>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <input name="HRG_TAWAR[]"
                                                                        id="HRG_TAWAR{{ $no }}" type="text"
                                                                        class="form-control HRG_TAWAR"
                                                                        value="{{ $detail->HRG_TAWAR }}" required>
                                                                </td>
                                                                <td>
    ...
    @section('footer-scripts')
        ...
        <script>
            ...
            <td><input name="ITEM_BR[]" id="ITEM_BR${idrow}" type="text" class="form-control" required></td>
            <td><input name="KLP[]" id="KLP${idrow}" type="text" class="form-control" required></td>
            <td><input name="HRG_TAWAR[]" id="HRG_TAWAR${idrow}" type="number" class="form-control" required></td>
