	...
	<div class="content-wrapper">
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0">Penjualan BC</h1>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item active">Penjualan BC</li>
						</ol>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<!-- Nav tabs -->
								<form method="POST" action="{{ url('jasper-bc-report') }}">
									@csrf
									<!-- Tab panes -->
												...
												<div class="form-group">
													<div class="row align-items-baseline mb-2">
														...
														<div class="col-4 mb-2">
															...
															<input type="text" name="sub" id="sub" class="form-control" value="">
														</div>
													</div>
													<div class="row align-items-baseline">
														...
														<div class="col-4 mb-2 text-right">
															...
															<button class="btn btn-danger mr-1" type="button" id="resetfilter" onclick="window.location='{{ url('rbc') }}'">Reset</button>
