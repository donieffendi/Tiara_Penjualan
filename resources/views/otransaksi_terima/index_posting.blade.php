            ...
            <div class="card">
              ...
              <!-- filter kolom di index -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-1">
                        <form method="POST" id="postingForm" action="{{ url('posting_stock_terima/') }}">
                            @csrf
              ...
              <input name="flagz"  class="form-control flagz" id="flagz" value="TE" hidden >
