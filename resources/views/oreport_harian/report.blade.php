	...
	<div class="content-wrapper">
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0">Harian Pembayaran</h1>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item active">Harian Pembayaran</li>
						</ol>
					</div>
				</div>
			</div>
											...
											<div class="pt-3">
												<div class="form-group">
													<div class="row align-items-end">
														...
														<div class="col-4 mb-2">
															<label for="no_file">No File</label>
															<input type="text" name="no_file" id="no_file" class="form-control">
														</div>
