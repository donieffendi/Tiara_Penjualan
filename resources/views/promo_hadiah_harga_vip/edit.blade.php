...
@section('content')
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="date" class="form-control form-control-sm"
                                                                ...
                                                                value="{{ $header && $header->TGL_MULAI ? date('Y-m-d', strtotime($header->TGL_MULAI)) : date('Y-m-d') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="date" class="form-control form-control-sm"
                                                                id="tgl_sls" name="tgl_sls"
                                                                value="{{ $header && $header->TGL_SLS ? date('Y-m-d', strtotime($header->TGL_SLS)) : date('Y-m-d') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body p-2">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text"
                                                                        class="form-control form-control-sm" id="kd_brg"
                                                                        name="kd_brg" placeholder="Kode Barang">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="hjvip_entry" class="form-label">Harga
                                                                    VIP</label>
                                                                <input type="number" class="form-control form-control-sm"
                                                                    id="hjvip_entry" name="hjvip_entry" step="0.01"
                                                                    placeholder="0.00">
                                                            </div>
                                                        </div>
                                                                ...
                                                                @if ($status == 'edit' && !empty($detail))
                                                                    @foreach ($detail as $index => $item)
                                                                        <tr data-kd-brg="{{ $item->KD_BRG }}"
                                                                            ...
                                                                            <td>{{ $item->KET_UK ?? '' }}</td>
                                                                            <td class="text-right">
                                                                                {{ number_format($item->HJ ?? 0, 2) }}</td>
                                                                            <td>
                                                                                <input type="hjvip" step="0.01"
                                                                                    class="form-control form-control-sm text-right"
                                                                                    name="details[{{ $index }}][hjvip]"
                                                                                    value="{{ $item->HJVIP }}">
                                                                            </td>
                                                                            <td>  <input type="ket" 
                                                                                    class="form-control form-control-sm text-right"
                                                                                    name="details[{{ $index }}][ket]"
                                                                                    value="{{ $item->KET }}"></td>
                                                                            ...
                                                                            <input type="hidden"
                                                                                ...
                                                                                value="{{ $item->NO_ID ?? 0 }}">
                                                                            <input type="hidden"
                                                                                name="details[{{ $index }}][rec]"
                                                                                value="{{ $item->REC ?? $index + 1 }}">
                                                                            <input type="hidden"
    ...
    <div class="modal fade" id="browseProductModal" tabindex="-1" aria-labelledby="browseProductModalLabel"
        aria-hidden="true">
...
@section('footer-scripts')
        ...
        function handleEnterKey(element) {
            ...
            switch (id) {
                ...
                default:
                    ...
                    var focusable = form.find('input,select,textarea,button').filter(
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success && response.exists && response.data) {
                            ...
                            $('#lblBarang').text(response.data.NA_BRG + ' | HJ: ' + formatNumber(response.data
                                .HJ));
    ...
    var newRow = `
        <tr data-kd-brg="${product.KD_BRG}" data-no-id="0">
            ...
            <!-- HJVIP langsung jadi input dengan name array -->
            <td>
                <input 
                    type="text"
                    name="details[${detailRowIndex}][hjvip]"
                    class="form-control form-control-sm text-right"
                    value="${hjvip}"
                >
            </td>
            ...
            <td>
                <input 
                    type="text"
                    name="details[${detailRowIndex}][ket]"
                ...
                success: function(response) {
                    ...
                    if (response.length > 0) {
                        response.forEach(function(item) {
                            ...
                            row +=
                                '<td><button type="button" class="btn btn-primary btn-sm" onclick="selectProduct(\'' +
