            ...
            <div class="card">
              ...
              <!-- filter kolom di index -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-1">
                        <form method="POST" id="postingForm" action="{{ url('posting_kirim_hijau/') }}">
                            @csrf
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="columnToggleForm">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
                                            value="3" id="columnUsrnm" checked>
              ...
              <input name="flagz"  class="form-control flagz" id="flagz" value="KH" hidden >
  ...
  $(document).ready(function() {
        ...
        window.toggleButton = function(button) {
            ...
            if (button.innerText === '+') {
                ...
                $.ajax({
                    url: '{{ route('get-detail-hkirim') }}', // Define the route to fetch detail data
                    method: 'GET',
                    data: {
                        no_bukti: no_bukti
