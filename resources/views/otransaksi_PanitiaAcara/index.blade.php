										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<form id="columnToggleForm">
													...
													<div class="form-check">
														<input class="form-check-input column-checkbox" type="checkbox" value="5" id="columnPanitia" checked>
														<label class="form-check-label" for="columnPanitia">Panitia</label>
													</div>
													<div class="form-check">
														<input class="form-check-input column-checkbox" type="checkbox" value="6" id="columnSeksi" checked>
														<label class="form-check-label" for="columnSeksi">Seksi</label>
													</div>
													<div class="form-check">
														<input class="form-check-input column-checkbox" type="checkbox" value="7" id="columnKepl" checked>
														<label class="form-check-label" for="columnKepl">Kepala</label>
													</div>
													<div class="form-check">
														<input class="form-check-input column-checkbox" type="checkbox" value="8" id="columnTotal" checked>
								...
								<table class="table-striped table-border table-hover nowrap datatable table table-fixed" id="datatable">
									<thead class="table-dark">
										<tr>
											...
											<th width="150px" style="text-align:center">Panitia</th>
											<th width="150px" style="text-align:center">Seksi</th>
											<th width="150px" style="text-align:center">Kepala</th>
...
@section('javascripts')
	...
	<script>
		...
		$(document).ready(function() {
			...
			$("div.test_btn").html(
				'<a class="btn btn-success" href="{{ url('TPanitiaAcara/edit?idx=0&tipx=new') }}" title="Tambah Data"><i class="fas fa-plus"></i> Tambah</a>'
			);
		});
