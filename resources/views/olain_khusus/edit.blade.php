...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form
                                    action="{{ $tipx == 'new' ? url('/khusus/store?flagz=' . $flagz . '') : url('/khusus/update/' . $header->NO_ID . '&flagz=' . $flagz . '') }}"
                                    ...
                                    <div class="tab-content mt-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-1">
                                                <input type="text" class="form-control KIRIM" id="KIRIM"
                                                    name="KIRIM" placeholder="Masukkan Type" value="{{ $header->CBG }}"
                                                    readonly>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input class="form-control date" on id="TGL" name="TGL"
                                            ...
                                            <div class="col-md-1">
                                                <input type="text" class="form-control TYPE" id="TYPE"
                                                    name="TYPE" placeholder="Masukkan Type" value="{{ $header->TYPE }}"
                                                    readonly>
                                            </div>
                                            ...
                                            <div class="col-md-1">
                                                <input type="text" class="form-control LPH1" id="LPH1"
                                                    name="LPH1" placeholder="Masukkan Lph">
                                            </div>
                                            ...
                                            <div class="col-md-1">
                                                <input type="text" class="form-control LPH2" id="LPH2"
                                                    name="LPH2" placeholder="Masukkan Lph">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" class="form-control NOTES" id="NOTES"
                                                    name="NOTES" placeholder="Masukkan Notes"
                                            ...
                                            <div class="col-md-1">
                                                <select id="GOLONGAN" class="form-control" name="GOLONGAN">
                                                    <option value="-" {{ $header->GOLONGAN == '-' ? 'selected' : '' }}
                                                        disable selected hidden>--Pilih Gol--</option>
                                                    <option value="NF"
                                                        {{ $header->GOLONGAN == 'NF' ? 'selected' : '' }}>NF</option>
                                                    <option value="ST"
                                                        {{ $header->GOLONGAN == 'ST' ? 'selected' : '' }}>ST</option>
                                                    <option value="FF"
                                                        {{ $header->GOLONGAN == 'FF' ? 'selected' : '' }}>FF</option>
                                                    <option value="PB"
                                                        {{ $header->GOLONGAN == 'PB' ? 'selected' : '' }}>PB</option>
                                                    <option value="FO"
                                                        {{ $header->GOLONGAN == 'FO' ? 'selected' : '' }}>FO</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-1">
                                                <input type="text" class="form-control BUTUH" id="BUTUH"
                                                    name="BUTUH" placeholder="Masukkan Kebutuhan">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-1">
                                                <input type="text" class="form-control SUB1" id="SUB1"
                                                    name="SUB1" placeholder="Masukkan Sub">
                                            </div>
                                            ...
                                            <div class="col-md-1">
                                                <input type="text" class="form-control SUB2" id="SUB2"
                                                    name="SUB2" placeholder="Masukkan Sub">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" class="form-control SUPP" id="SUPP"
                                                    name="SUPP" placeholder="Masukkan Sup">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-8"></div>
                                            <div class="col-md-3">
                                                <button class="btn btn-primary" type="button" id="AMBIL"
                                                    class="AMBIL" name="AMBIL" onclick="getSod()">Ambil Data</button>
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <div class="col-md-1" align="right">
                                                <label for="KD_BRGX" class="form-label">Item</label>
                                            </div>
                                            <div class="col-md-2">
                                                <input type="text" class="form-control KD_BRGX" id="KD_BRGX"
                                                    name="KD_BRGX" placeholder="" value="">
                                            ...
                                            <div class="col-md-1">
                                                <input type="text" class="form-control nominal-input" id="STOK"
                                                    name="STOK"
                                                    value="{{ number_format($header->STOK, 0, ',', '.') }}" readonly>
                                            </div>
                                            <div class="col-md-1" align="right">
                                                <label for="QTY1" class="form-label">Stok</label>
                                            </div>
                                            <div class="col-md-1">
                                        ...
                                        <table id="datatable" class="table table-striped table-border table-responsive">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input name="KET_KEM[]" id="KET_KEM{{ $no }}"
                                                                type="text" class="form-control KET_KEM"
                                                                value="{{ $detail->ket_kem }}" readonly required>
                                                        </td>
                                                        <td>
                                                            <input name=" QTY[]" onclick="select()" onblur="hitung()"
                                                                value="{{ $detail->qty }}" id="QTY{{ $no }}"
                                                                type="text" style="text-align: right"
                                                                class="form-control QTY">
                                                        </td>
                                                        <td>
                                                            <input name=" HARGA[]" onclick="select()" onblur="hitung()"
                                                                value="{{ $detail->harga }}"
                                                                id="HARGA{{ $no }}" type="text"
                                                                style="text-align: right" class="form-control HARGA">
                                                        </td>
                                                        <td>
                                                            <input name=" TOTAL[]" onclick="select()" onblur="hitung()"
                                                                value="{{ $detail->total }}"
                                                                id="TOTAL{{ $no }}" type="text"
                                                                style="text-align: right" class="form-control TOTAL">
                                                        </td>
                                                        <td>
                                                            <input name="LPH[]" id="LPH{{ $no }}"
                                                                type="text" class="form-control LPH"
                                                                value="{{ $detail->LPH }}" readonly required>
                                                        </td>
                                                        <td>
                                                            <input name=" STOK[]" onclick="select()" onblur="hitung()"
                                                                value="{{ $detail->stok }}" id="STOK{{ $no }}"
                                                                type="text" style="text-align: right"
                                                                class="form-control STOK">
                                                        </td>

                                                        <td>
                                                            <input name=" STOKZ[]" onclick="select()" onblur="hitung()"
                                                                value="{{ $detail->stokz }}"
                                                                id="STOKZ{{ $no }}" type="text"
                                                                style="text-align: right" class="form-control STOKZ">
                                                        </td>
                                            ...
                                            <tfoot>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td><input class="form-control TTOTAL_QTY  text-primary"
                            ...
                            <div class="mt-3 col-md-12 form-group row">
                                <div class="col-md-4">
                                    <button hidden type="button" id='TOPX'
                                        onclick=`location.href='{{ url('/khusus/edit/?idx=' . $idx . '&tipx=top&flagz=' . $flagz . '') }}'
                                        ` class="btn btn-outline-primary">Top</button>
                                    <button hidden type="button" id='PREVX'
                                        onclick=`location.href='{{ url('/khusus/edit/?idx=' . $header->NO_ID . '&tipx=prev&flagz=' . $flagz . '&buktix=' . $header->NO_BUKTI) }}'
                                        ` class="btn btn-outline-primary">Prev</button>
                                    <button hidden type="button" id='NEXTX'
                                        onclick=`location.href='{{ url('/khusus/edit/?idx=' . $header->NO_ID . '&tipx=next&flagz=' . $flagz . '&buktix=' . $header->NO_BUKTI) }}'
                                        ` class="btn btn-outline-primary">Next</button>
                                    <button hidden type="button" id='BOTTOMX'
                                        onclick=`location.href='{{ url('/khusus/edit/?idx=' . $idx . '&tipx=bottom&flagz=' . $flagz . '') }}'
                                        ` class="btn btn-outline-primary">Bottom</button>
                                </div>
                                <div class="col-md-5">
                                    <button hidden type="button" id='NEWX'
                                        onclick=`location.href='{{ url('/khusus/edit/?idx=0&tipx=new&flagz=' . $flagz . '') }}'
                                    ...
                                    <button hidden type="button" id='UNDOX'
                                        onclick=`location.href='{{ url('/khusus/edit/?idx=' . $idx . '&tipx=undo&flagz=' . $flagz . '') }}'
    ...
    <div class="modal fade" id="browseSuplierModal" tabindex="-1" role="dialog"
        aria-labelledby="browseSuplierModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="browseSoModal" tabindex="-1" role="dialog" aria-labelledby="browseSoModalLabel"
        aria-hidden="true">
...
@section('footer-scripts')
    ...
    <script>
                    ...
                    success: function(response) {
                        ...
                        for (i = 0; i < resp.length; i++) {
                            ...
                            dTableBSuplier.row.add([
                                '<a href="javascript:void(0);" onclick="chooseSuplier(\'' +
                                resp[i].KODES + '\', \'' + resp[i].NAMAS + '\',  \'' + resp[
                                    i].ALAMAT + '\', \'' + resp[i].KOTA + '\', \'' + resp[i]
                                .PKP + '\')">' + resp[i].KODES + '</a>',
                                resp[i].NAMAS,
                                resp[i].ALAMAT,
                                resp[i].KOTA,
...

                    {
                        ...
                        if (resp.length > 1) {
                            ...
                            for (i = 0; i < resp.length; i++) {
                                ...
                                var kodeNamas = (resp[i].KODES != '' && resp[i].NAMAS != '') ? resp[i]
                                    .KODES + '-' + resp[i].NAMAS : '';

                                dTableBBarang.row.add([
                                    '<a href="javascript:void(0);" onclick="chooseBarang(\'' +
                                    resp[i].KD_BRG + '\', \'' + resp[i].NA_BRG + '\' , \'' +
                                    resp[i].SATUAN + '\', \'' + resp[i].KODES + '\', \'' + resp[
                                        i].NAMAS + '\' )">' + resp[i].KD_BRG + '</a>',
                                    resp[i].NA_BRG,
                                    resp[i].SATUAN,
                                    kodeNamas,
                            ...
                            var kodeNamas = (resp[0].KODES != '' && resp[0].NAMAS != '') ? resp[0]
                                .KODES + '-' + resp[0].NAMAS : '';
        ...
        var selectedKD_BRG = null;
        var isProcessingQty = false;


        $("#KD_BRGX").on("keydown", function(e) {
            ...
            if (input.length >= 8) {
                dataSend.BARCODE = input;
                isBarcode = true;
            } else {
                dataSend.KD_BRG = input;
            }

            $.ajax({
                type: "GET",
                url: "{{ url('khusus/ambil-detail-kd-brg') }}",
                data: dataSend,
                success: function(resp) {
                    ...
                    if (isBarcode) {
                        $("#KD_BRGX").val(row.BARCODE);
                    } else {
                        $("#KD_BRGX").val(row.KD_BRG);
                    }

                    $("#HB").val(
                        parseInt(row.HARGA || 0).toLocaleString("id-ID")
                    );

                    selectedKD_BRG = row.KD_BRG;
                    isProcessingQty = false;
        ...
        $("#QTY1").on("keydown", function(e) {
            if (e.which !== 13) return;

            e.preventDefault();

            if (isProcessingQty) return;
            isProcessingQty = true;
        ...
        function getDetail(kd_brg_header) {
            if (typeof kd_brg_header === 'undefined' || kd_brg_header === null) return;
            kd_brg_header = kd_brg_header.toString().trim();

            let qtyTambahRaw = $("#QTY1").val() || "0";
            let qtyTambah = parseInt(
                qtyTambahRaw.toString().replace(/[^0-9\-]/g, ''),
                10
            ) || 0;
            ...
            $("#detailSod tr").each(function(index) {
                var $kdInput = $(this).find("input[name='KD_BRG[]']");
                var kd_brg_detail = ($kdInput.val() || '').toString().trim();

                if (kd_brg_detail === kd_brg_header) {
                    var $qtyInput = $(this).find("input[name='QTY[]']");
                    var $hargaInput = $(this).find("input[name='HARGA[]']");
                    var $totalInput = $(this).find("input[name='TOTAL[]']");

                    var qtyLama = parseFloat(($qtyInput.val() || '0').toString().replace(/\./g, '').replace(',',
                        '.')) || 0;
                    var harga = parseFloat(($hargaInput.val() || '0').toString().replace(/\./g, '').replace(',',
                        '.')) || 0;

                    //var qtyBaru = qtyTambah;
                    //var totalBaru = qtyBaru * harga;
                    ...
                    $qtyInput.val(formatID(qtyBaru));
                    $totalInput.val(formatID(totalBaru));

                    sudahAda = true;

                    return false; // penting! supaya stop setelah update baris yang match
                }
            });
            ...
            if (!sudahAda) {
                $.ajax({
                    ...
                    success: function(resp) {
                        if (resp.length > 0) {
                            var row = resp[0];
                            var lastRow = $('#detailSod tr').length;
                            var idx = lastRow;

                            var totalBaru = qtyTambah * (parseFloat(row.HARGA.toString().replace(/\./g, '')
                                .replace(',', '.')) || 0);

                            var html = `
                        <tr>
                            <td><input name='REC[]' id='REC${idx}' value='${idx + 1}' type='text' class='REC form-control' readonly style='text-align:center'></td>
                            <td><input name='KD_BRG[]' id='KD_BRG${idx}' value='${row.KD_BRG}' type='text' class='form-control KD_BRG' readonly></td>
                            <td><input name='NA_BRG[]' id='NA_BRG${idx}' value='${row.NA_BRG}' type='text' class='form-control NA_BRG' readonly></td>
							<td><input name='KET_KEM[]' id='KET_KEM${idx}' value='${row.KET_KEM}' type='text' class='form-control KET_KEM' readonly></td>
                            <td><input name='QTY[]' id='QTY${idx}'  value='${formatID(qtyTambah)}' type='text' style='text-align:right' class='form-control QTY text-primary'></td>
                            <td><input name='HARGA[]' id='HARGA${idx}' value='${row.HARGA}' type='text' style='text-align:right' class='form-control HARGA text-primary' readonly></td>
                            <td><input name='TOTAL[]' id='TOTAL${idx}'  value='${formatID(totalBaru)}' type='text' style='text-align:right' class='form-control TOTAL text-primary' readonly></td>
							<td><input name='LPH[]' id='LPH${idx}' value='${row.LPH}' type='text' class='form-control LPH' readonly></td>
                            <td><input name='STOK[]' id='STOK${idx}' value='${row.STOK}' type='text' style='text-align:right' class='form-control STOK text-primary' readonly></td>
						    <td><input name='STOKZ[]' id='STOKZ${idx}' value='${row.STOKZ}' type='text' style='text-align:right' class='form-control STOKZ text-primary' readonly></td>
							<td><input name='KET[]' id='KET${idx}' value='${row.KET}' type='text' class='form-control KET' readonly></td>
                            <td><button type='button' id='DELETEX${idx}' class='btn btn-sm btn-circle btn-outline-danger btn-delete'><i class='fa fa-fw fa-trash'></i></button></td>
                        </tr>`;
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        loc = "{{ url('/khusus/delete/' . $header->NO_ID) }}" + '?flagz=' +
        ...
        function CariBukti() {
            ...
            var flagz = "{{ $flagz }}";
            var cari = $("#CARI").val();
            var loc = "{{ url('/khusus/edit/') }}" + '?idx={{ $header->NO_ID }}&tipx=search&flagz=' + encodeURIComponent(
