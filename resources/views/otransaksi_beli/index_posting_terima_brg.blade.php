    ...
    <div class="content-wrapper">
        ...
        @if (session('status'))
            ...
            <script>
                Swal.fire({
                    title: 'Deleted!',
                    text: 'Data has been deleted. {{ session('
                            status ') }}',
                    icon: 'success',
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <form method="POST" id="postingForm" action="{{ url('posting_terima_brg/') }}">
                                            @csrf
                                ...
                                <input name="flagz" class="form-control flagz" id="flagz" value="BL" hidden>
                ...
                columns: [
                    ...
                    //         },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return ' <h5><span class="badge badge-pill badge-success">' + formattedData +
                                '</span></h5>';
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return `<input type="checkbox" class="update-posted" data-id="${id}" ${checked}>`;
                        }
                    }
