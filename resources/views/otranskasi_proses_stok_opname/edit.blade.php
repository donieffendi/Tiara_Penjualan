                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12">
                                    ...
                                    <button id="btn-hapus-positif" type="button" class="btn btn-danger">
                                        Hapus Positif
                                    </button>
        ...
        $(document).ready(function() {
            ...
            $('#btn-hapus-positif').click(function() {
                ...
                $('#tbody-detail tr').each(function() {
                    ...
                    let saldo = parseFloat($(this).find('.saldo').val()) || 0;
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil',
                    text: 'Baris dengan saldo > 0 berhasil dihapus',
                    timer: 1500,
                    showConfirmButton: false
                });
            });
            ...
            $('#btn-hapus-negatif').click(function() {
                ...
                $('#tbody-detail tr').each(function() {
                    ...
                    if (saldo < 0) {
                        $(this).remove(); // hapus baris saldo negatif
                    }
                });
