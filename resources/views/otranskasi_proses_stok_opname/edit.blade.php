							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control form-control-sm" name="sub" id="sub" value="{{ $header->sub ?? '' }}"
											placeholder="Sub kategori" required>
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="text" class="form-control form-control-sm" id="item1" placeholder="Item awal">
									</div>
								</div>
								<div class="col-md-2">
									<div class="form-group">
										<label>Item To</label>
										<input type="text" class="form-control form-control-sm" id="item2" value="ZZZZ" placeholder="Item akhir">
									</div>
								</div>
								<div class="col-md-2">
									<div class="form-group">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="number" class="form-control form-control-sm" id="cek1" placeholder="No awal">
									</div>
								</div>
								<div class="col-md-2">
									<div class="form-group">
										<label>Cek To</label>
										<input type="number" class="form-control form-control-sm" id="cek2" placeholder="No akhir">
									</div>
								</div>
							</div>
								...
								<table class="table-bordered table-striped table-sm table" id="table-detail">
									<thead class="thead-dark">
										<tr>
											...
											<th width="10%" class="text-center">Supp</th>
										...
										@if (!empty($detail) && count($detail) > 0)
											@foreach ($detail as $key => $row)
												<tr data-no-id="{{ $row->no_id ?? 0 }}">
													...
													<td>
														<input type="text" class="form-control form-control-sm" name="detail[{{ $key }}][stand]"
															value="{{ $row->STAND ?? '' }}" readonly style="background-color: #e9ecef;">
													</td>
													<td>
														<input type="number" class="form-control form-control-sm text-right" name="detail[{{ $key }}][hj]"
															value="{{ $row->hj }}" readonly style="background-color: #e9ecef;">
													</td>
													<td>
														<input type="number" class="form-control form-control-sm text-right" name="detail[{{ $key }}][saldo]"
															value="{{ $row->saldo }}" readonly style="background-color: #e9ecef;">
													</td>
													<td>
														<input type="text" class="form-control form-control-sm" name="detail[{{ $key }}][supp]" value="{{ $row->SUPP ?? '' }}"
															readonly style="background-color: #e9ecef;">
													</td>
		...
		$(document).ready(function() {
			...
			function addRowFromData(item) {
                ...
                <tr data-no-id="0">
                    ...
                    <td>
                        <input type="text" class="form-control form-control-sm" name="detail[${rowIndex}][stand]" value="${item.STAND || ''}" readonly style="background-color: #e9ecef;">
                    </td>
                    <td>
                    ...
                    <td>
                        <input type="number" class="form-control form-control-sm text-right" name="detail[${rowIndex}][saldo]" value="${item.saldo || 0}" readonly style="background-color: #e9ecef;">
                    </td>
                    <td>
