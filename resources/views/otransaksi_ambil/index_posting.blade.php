            ...
            <div class="card">
              ...
              <!-- filter kolom di index -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-1">
                        <form method="POST" id="postingForm" action="{{ url('posting_ambil_brg/') }}">
                            @csrf
                            ...
                            <div class="modal-body">
                                ...
                                <form id="columnToggleForm">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="columnTqty">Total_QTY</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input column-checkbox" type="checkbox"
              ...
              <input name="flagz"  class="form-control flagz" id="flagz" value="AM" hidden >
