...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{($tipx=='new')? url('/ubahdim/store/') : url('/ubahdim/update/'.$header[0]->NO_BUKTI ) }}" method="POST" name ="entri" id="entri" >
						...
						<div class="mt-3 col-md-12 form-group row">
							<div class="col-md-4">
								<button hidden type="button" id='TOPX'  onclick="location.href='{{url('/ubahdim/edit/?idx=' .$idx. '&tipx=top')}}'" class="btn btn-outline-primary">Top</button>
								<button hidden type="button" id='PREVX' onclick="location.href='{{url('/ubahdim/edit/?idx='.($header[0]->NO_ID ?? 0).'&tipx=prev&buktix='.($header[0]->NO_BUKTI ?? '') )}}'" class="btn btn-outline-primary">Prev</button>
								<button hidden type="button" id='NEXTX' onclick="location.href='{{url('/ubahdim/edit/?idx='.($header[0]->NO_ID ?? 0).'&tipx=next&buktix='.($header[0]->NO_BUKTI ?? '') )}}'" class="btn btn-outline-primary">Next</button>
								<button hidden type="button" id='BOTTOMX' onclick="location.href='{{url('/ubahdim/edit/?idx=' .$idx. '&tipx=bottom')}}'" class="btn btn-outline-primary">Bottom</button>
							</div>
							<div class="col-md-5">
								<button hidden type="button" id='NEWX' onclick="location.href='{{url('/ubahdim/edit/?idx=0&tipx=new')}}'" class="btn btn-warning">New</button>
								<button hidden type="button" id='EDITX' onclick='hidup()' class="btn btn-secondary">Edit</button>                    
								<button hidden type="button" id='UNDOX' onclick="location.href='{{url('/ubahdim/edit/?idx=' .$idx. '&tipx=undo' )}}'" class="btn btn-info">Undo</button> 
							...
							<div class="col-md-3">
								...
								<!-- <button type="button" id='CLOSEX'  onclick="location.href='{{url('/ubahdim' )}}'" class="btn btn-outline-secondary">Close</button> -->
...
///////////////////////////////////////
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				Swal.fire({
	            	...
	            	loc = "{{ url('/ubahdim/delete/'.($header[0]->NO_ID ?? 0)) }}";
	...
	function CariBukti() {
		...
		var cari = $("#CARI").val();
		var loc = "{{ url('/ubahdim/edit/') }}" + '?idx={{ $header[0]->NO_ID ?? 0}}&tipx=search&buktix=' +encodeURIComponent(cari);
		window.location = loc;
