                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" id="txtBukti"
                                                placeholder="Masukkan No Bukti JL/BL" maxlength="20">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" id="txtSP"
                                                placeholder="Masukkan No SP" maxlength="20">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover table-sm" id="tableCetakSP"
                                        style="width:100%">
                                        <thead>
                                            <tr>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-striped table-bordered table-hover table-sm" id="tableBrowseBukti">
                        <thead>
                            <tr>
                                <th>No Bukti</th>
                                <th>Tanggal</th>
