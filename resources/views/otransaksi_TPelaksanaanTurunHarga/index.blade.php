                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table-bordered table-hover table" id="tableMain"
                                        style="width:100%">
                                        <thead>
                                            <tr>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="panel-detail" id="panelDetail">
                            ...
                            <div class="table-responsive">
                                <table class="table-striped table-bordered table-hover table" id="tableDetail"
                                    style="width:100%">
                                    <thead>
                                        <tr>
                                            <th width="50px" class="text-center">No</th>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="panel-monitor" id="panelMonitor">
                            ...
                            <div class="table-responsive">
                                <table class="table-striped table-bordered table-hover table" id="tableMonitor"
                                    style="width:100%">
                                    <thead>
                                        <tr>
                                            <th width="50px" class="text-center">No</th>
