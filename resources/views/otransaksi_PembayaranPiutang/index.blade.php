										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<form id="columnToggleForm">
													...
													<div class="form-check">
														<input class="form-check-input column-checkbox" type="checkbox" value="4" id="columnJTempo" checked>
														<label class="form-check-label" for="columnJTempo">Jatuh Tempo</label>
													</div>
													<div class="form-check">
														<input class="form-check-input column-checkbox" type="checkbox" value="5" id="columnKodeC" checked>
														<label class="form-check-label" for="columnKodeC">Kode Customer</label>
													</div>
													<div class="form-check">
														<input class="form-check-input column-checkbox" type="checkbox" value="6" id="columnNamaC" checked>
														<label class="form-check-label" for="columnNamaC">Nama Customer</label>
													</div>
													<div class="form-check">
													...
													<div class="form-check">
														<input class="form-check-input column-checkbox" type="checkbox" value="10" id="columnSisa" checked>
														<label class="form-check-label" for="columnSisa">Sisa</label>
													</div>
													<div class="form-check">
														<input class="form-check-input column-checkbox" type="checkbox" value="11" id="columnStatus" checked>
								...
								<table class="table-striped table-border table-hover nowrap datatable table table-fixed" id="datatable">
									<thead class="table-dark">
										<tr>
											...
											<th width="80px" style="text-align:center">Jatuh Tempo</th>
											<th width="80px" style="text-align:center">Kode Customer</th>
											<th width="200px" style="text-align:center">Nama Customer</th>
											<th width="100px" style="text-align:center">Total</th>
											<th width="100px" style="text-align:center">Bayar</th>
											<th width="100px" style="text-align:center">Lain</th>
											<th width="100px" style="text-align:center">Sisa</th>
	...
	<script>
		...
		$(document).ready(function() {
			var dataTable = $('.datatable').DataTable({
				...
				ajax: {
					url: '{{ route('get-TPembayaranPiutang') }}'
				},
				columns: [{
						data: 'DT_RowIndex',
						orderable: false,
			...
			$("div.test_btn").html(
				'<a class="btn btn-success" href="{{ url('TPembayaranPiutang/edit?idx=0&tipx=new') }}" title="Tambah Data"><i class="fas fa-plus"></i> Tambah</a>'
			);
		});
