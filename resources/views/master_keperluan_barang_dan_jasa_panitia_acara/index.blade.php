...
<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
		        <h1 class="m-0">Keperluan Barang Dan Jasa Panitia Acara</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Keperluan Barang Dan Jasa Panitia Acara</li>
            </ol>
          </div>
        </div>
      </div>
...
<script>
  $(document).ready(function() {
    ...
    $("div.test_btn").html(`<a class="btn btn-lg btn-md btn-success" href="{{url('brg-jasa-pa/edit?idx=0&tipx=new')}}"> 
    ...
    $('#btnPrint').on('click', function() {
      Swal.fire({
          title: 'Cetak Data Barang & Jasa?',
          text: "Cetakan akan dibuka di tab baru.",
          icon: 'question',
          ...
          if (result.isConfirmed) {
              ...
              window.open(`{{ url('brg-jasa/print') }}`, '_blank');
          }
      });
    });
