            ...
            <div class="card">
              ...
              <!-- filter kolom di index -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-1">
                        <form method="POST" id="postingForm" action="{{ url('posting_po/') }}">
                            @csrf
              ...
              <input name="flagz"  class="form-control flagz" id="flagz" value="PO" hidden >
              <input name="golz"  class="form-control golz" id="golz" value="J" hidden >
...
<script>
  ...
  $(document).ready(function() {
        ...
        // $("div.test_btn").html(
        //     '<a class="btn btn-md btn-success" href="{{url('po/edit?flagz='.$flagz.'&golz='.$golz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3"></i> </a> ' +
        //     '<a class="btn btn-md btn-warning" href="{{url('po/otomatis?flagz='.$flagz.'&golz='.$golz.'&tahapz=tahap1')}}"> PO Otomatis T1 </a> ' +
        //     '<a class="btn btn-md btn-warning" href="{{url('po/otomatis?flagz='.$flagz.'&golz='.$golz.'&tahapz=tahap2')}}"> PO Otomatis T2 </a> ' +
        //     '<a class="btn btn-md btn-warning" href="{{url('po/otomatis?flagz='.$flagz.'&golz='.$golz.'&tahapz=tahap3')}}"> PO Otomatis T3 </a> '
        // );
