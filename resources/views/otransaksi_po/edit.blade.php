                    ...
                    <form action="{{($tipx=='new')? url('/po/store?flagz='.$flagz.'&golz='.$golz.'') : url('/po/update/'.$header->NO_ID.'&flagz='.$flagz.'&golz='.$golz.'' ) }}" method="POST" name ="entri" id="entri" >
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="form-group row">
								...
								<div class="col-md-1" align="right">
									<label for="JTEMPO" class="form-label">J Tempo 1</label>
								</div>
								<div class="col-md-1">
								...
								<div class="col-md-1" align="right">
									<label for="JTEMPO2" class="form-label">J Tempo 2</label>
								</div>
								<div class="col-md-1">
									<input class="form-control date" id="JTEMPO2" name="JTEMPO2" data-date-format="dd-mm-yyyy" type="text" autocomplete="off" value="{{date('d-m-Y',strtotime($header->JTEMPO2))}}">
								</div>
								
								<div class="col-md-1" align="right">
									<label for="JTEMPO3" class="form-label">J Tempo 3</label>
								</div>
								<div class="col-md-1">
									<input class="form-control date" id="JTEMPO3" name="JTEMPO3" data-date-format="dd-mm-yyyy" type="text" autocomplete="off" value="{{date('d-m-Y',strtotime($header->JTEMPO3))}}">
								</div>
                            </div>
