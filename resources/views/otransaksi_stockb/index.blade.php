...
<script>
  ...
  $(document).ready(function() {
        ...
        $("div.test_btn").html(
            '<a class="btn btn-lg btn-md btn-success" href="{{url('stockb/edit?flagz='.$flagz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a> ' +
            '<a {{ $flagz == "SZ" ? "" : "hidden" }} class="btn btn-lg btn-md btn-warning  process-btn" href="{{url('stockb/sootomatis?flagz='.$flagz.'')}}">So Otomatis</i></a>'
        );
    });
