                            ...
                            <div class="card-body">
                                ...
                                <div class="info-box">
                                    ...
                                    <ul class="mb-0">
                                        ...
                                        <li>Klik <strong>Mulai</strong> untuk memulai event Hari Raya (mengubah LPH barang)
                                        </li>
                                        <li>Klik <strong>Hentikan</strong> untuk menghentikan event dan mengembalikan LPH
                                        </li>
                                        <li>Klik <strong>Rekap</strong> untuk melihat rekap penjualan selama periode event
                                        </li>
                                        <li>Klik <strong>Hapus</strong> untuk menghapus data usulan (hanya data yang belum
                                            diposting)</li>
                                    </ul>
                                </div>
...
@section('javascripts')
    ...
    <script>
                    ...
                    error: function(xhr, error, code) {
                        ...
                        if (xhr.status === 500 || xhr.status === 400) {
                            ...
                            try {
                                ...
                                errorMsg =
                                    'Tabel database belum dibuat. Silakan jalankan file SQL: sql/create_table_usul_hraya.sql';
                            }
        ...
        $(document).on('click', '.btn-print', function() {
            ...
            if (!nobukti) {
                Swal.fire('Error', 'Nomor bukti tidak ditemukan!', 'error');
                return;
            }

            let url = '/tlphhariraya/print?nobukti=' + encodeURIComponent(nobukti);

            window.open(url, '_blank');
        });

        $(document).on('click', '.btn-print-evaluasi', function() {
            let nobukti = $(this).data('nobukti');

            $.ajax({
                url: '/tlphhariraya/print-evaluasi',
                type: 'GET',
                data: {
                    nobukti: nobukti
                },
                ...
                success: function(data, status, xhr) {
                    ...
                    // kalau flag konfirmasi dikirim
                    if (xhr.getResponseHeader('X-Need-Confirm') === '1') {

                        Swal.fire({
                            title: 'Rekap sudah ada',
                            text: 'Ingin proses ulang ' + nobukti + ' ?',
                            icon: 'warning',
                            showCancelButton: true,
                            ...
                            let ulang = result.isConfirmed ? 'Y' : '';

                            window.open('/tlphhariraya/print-evaluasi?nobukti=' +
