                            ...
                            <div class="card-body">
                                ...
                                <div class="info-box">
                                    ...
                                    <ul class="mb-0">
                                        ...
                                        <li>Tentukan <strong>Tgl H.Raya</strong>, <strong>Tgl Dr</strong>, dan
                                            <strong>Sampai Tgl</strong>
                                        </li>
                                        <li>Masukkan <strong>Sub Item</strong> (Kode Barang) atau gunakan browse untuk
                                            mencari</li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="tgl_raya" name="tgl_raya"
                                                    value="{{ $tgl_raya }}" required
                                                    {{ $posted == 1 ? 'readonly' : '' }}>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="kd_event" name="kd_event" required
                                                    {{ $posted == 1 ? 'disabled' : '' }}>
                                                    <option value="">-- Pilih Hari Raya --</option>
                                                    @foreach ($listHariRaya as $hr)
                                                        <option value="{{ $hr->kode }}"
                                                            {{ $kd_event == $hr->kode ? 'selected' : '' }}>
                                                            {{ $hr->kode }} - {{ $hr->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="section-box">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="kd_brg">Sub Item <span
                                            ...
                                            <div class="col-md-6">
                                                <!-- LPH H.Raya -->
                                                <div class="form-group">
                                                    <label for="lph_raya">LPH H.Raya <span
                                                            class="text-danger">*</span></label>
                                                    <input type="number" class="form-control text-right" id="lph_raya"
                                                ...
                                                @if (!empty($detail))
                                                    @foreach ($detail as $index => $item)
                                                        <tr data-id="{{ $item->NO_ID }}">
                                                            ...
                                                            <td>{{ $item->NA_BRG }}</td>
                                                            <td>{{ $item->KET_UK }}</td>
                                                            <td class="text-right">{{ number_format($item->LPH_LAMA, 2) }}
                                                            </td>
                                                            <td class="text-right">{{ number_format($item->LPH_RAYA, 2) }}
                                                            </td>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        setTimeout(function () {
    window.location.href = "{{ url('tlphhariraya/edit') }}/" + currentNoBukti;
}, 500);
