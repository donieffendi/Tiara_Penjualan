					...
					@if (Auth::user()->divisi == 'superadmin' || Auth::user()->divisi == 'programmer')
						...
						<div class="mega-menu" id="d">
							...
							<div class="row d-flex">
								...
								<div class="col-md-3">
									<div class="menu-card" style="border:1px solid #bd2c8d; background-color:#fbb6e4;">
										<a href="javascript:addTab('Diskon Jenjang', '{{ url('disj') }}')">
											<i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-percent icon-pink"></i>
											<h6>Diskon Jenjang</h6>
										</a>
									</div>
								</div>
								<div class="col-md-3">
									<div class="menu-card" style="border:1px solid #bd2c8d; background-color:#fbb6e4;">
										<a href="javascript:addTab('Brg.Ord.Ke DC', '{{ url('ondc') }}')">
											<i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-warehouse icon-pink"></i>
											<h6>Barang Order Ke DC</h6>
										</a>
									</div>
								</div>
							</div>
