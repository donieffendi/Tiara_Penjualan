					...
					<div class="card">
						<div class="card-body">
							<form method="GET" action="{{ route('get-barangobralvip-report') }}" id="reportForm">
								...
								<div class="row align-items-end mb-4" id="OB">
									<button class="btn btn-primary mr-2 ml-3" type="button" onclick="">
										<i class="fas fa-print mr-1"></i>Buat Retur OB
									</button><button class="btn btn-primary mr-2" type="button" onclick="">
										<i class="fas fa-print mr-1"></i>Kirim File OB ke F.Sanglah
									</button>
								</div>
