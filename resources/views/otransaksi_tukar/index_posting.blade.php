                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-1">
                                        <form method="POST" id="postingForm" action="{{ url('posting_tukar/') }}">
                                            @csrf
                                ...
                                <input name="flagz" class="form-control flagz" id="flagz" value="TK" hidden>
            ...
            var dataTable = $('.datatable').DataTable({
                ...
                columns: [
                    ...
                    // {data: 'TOTAL_QTY', name: 'TOTAL_QTY', render: $.fn.dataTable.render.number( ',', '.', 0, '' )},
                    {
                        ...
                        name: 'TOTAL_QTY',
                        render: function(data, type, row, meta) {
                            var formattedData = $.fn.dataTable.render.number(',', '.', 0, '')
                                .display(data);
                            return ' <h5><span class="badge badge-pill badge-success">' +
                                formattedData + '</span></h5>';
                        }
                    },
                    {
                        data: 'NOTES',
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return `
            <div class="form-check d-flex align-items-center" style="margin-top: 10px;">
