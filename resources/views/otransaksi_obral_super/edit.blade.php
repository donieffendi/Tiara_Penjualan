                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="{{ route($menuType == 'FS' ? 'tentryflashsale' : 'tobralsupermarket') }}"
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control form-control-sm" name="tgl_mulai"
                                            value="{{ $header->tgl_mulai ?? date('Y-m-d') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>s/d <span class="text-danger">*</span></label>
                                        <input type="date" class="form-control form-control-sm" name="tgl_sls"
                                            value="{{ $header->tgl_sls ?? date('Y-m-d') }}" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-sm">
                                            <input type="text" class="form-control form-control-sm" name="no_file"
                                                id="no_file" value="{{ $header->no_file ?? '' }}"
                                        ...
                                        <!-- @if (!empty($detail) && count($detail) > 0)-->
                                            @foreach ($detail as $key => $row)
                                                <tr data-no-id="{{ $row->no_id ?? 0 }}">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-control-sm"
                                                            name="detail[{{ $key }}][ket_uk]"
                                                            value="{{ $row->ket_uk ?? '' }}" readonly
                                                            style="background-color: #e9ecef;">
                                                    </td>
                                                    <td>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success && response.data.length > 0) {
                            ...
                            Swal.fire('Berhasil', response.data.length +
                                ' barang berhasil dimuat', 'success');
                        } else {
