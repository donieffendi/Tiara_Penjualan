      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <form method="POST" id="entri" action="{{url('hbrg2/proses')}}">
                    @csrf
                ...
                <table class="table table-fixed table-striped table-border table-hover nowrap datatable" id="datatable">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th scope="col" style="text-align: center">Terima GZ</th>
                            <th scope="col" style="text-align: center">AT GZ</th>
                            <th scope="col" style="text-align: center">BK GZ</th>
                            <th scope="col" style="text-align: center">Terima MM</th>
                            <th scope="col" style="text-align: center">AT MM</th>
                            <th scope="col" style="text-align: center">BK MM</th>
                        </tr>		
                    </thead>
  ...
  $(document).ready(function() {
        var dataTable = $('.datatable').DataTable({
            ...
            [
                ...
                {data: 'trmgz', name: 'trmgz'},
                {data: 'atgz', name: 'atgz'},
                {data: 'bkgz', name: 'bkgz'},
                {data: 'catgz', name: 'catgz'},
                {data: 'atmm', name: 'atmm'},
                {data: 'bkmm', name: 'bkmm'},
            ],
        ...
        $('#btnPrint').on('click', function() {
          ...
          Swal.fire({
              ...
              if (result.isConfirmed) {
                  ...
                  window.open(`{{ url('hbrg2/cetak') }}?search=${encodeURIComponent(searchValue)}`, '_blank');
              }
          });
        });
      });
