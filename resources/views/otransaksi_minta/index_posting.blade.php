                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-1">
                                        <form method="POST" id="postingForm" action="{{ url('posting_stock_minta/') }}">
                                            @csrf
                                ...
                                <input name="flagz" class="form-control flagz" id="flagz" value="MT" hidden>
...
@section('javascripts')
    ...
    <script>
        ...
        `;
            ...
            // $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{ url('minta/edit?flagz=' . $flagz . '&idx=0&tipx=new') }}"> <i class="fas fa-plus fa-sm md-3" ></i></a');
            ...
            window.toggleButton = function(button) {
                ...
                if (button.innerText === '+') {
                    ...
                    $.ajax({
                        url: '{{ route('get-detail-minta') }}', // Define the route to fetch detail data
                        method: 'GET',
                        data: {
                            no_bukti: no_bukti
