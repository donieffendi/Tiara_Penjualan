...
<script>
    ...
    baris=<?=$no?>;
				...
				success: function( response )
				{
					...
					for(i=0; i<resp.length; i++){
						...
						dTableBKirim.row.add([
							'<a href="javascript:void(0);" onclick="chooseKirim(\''+resp[i].NO_KIRIM+'\', \''+resp[i].CBG_TUJU+'\' )">'+resp[i].NO_KIRIM+'</a>',
							resp[i].CBG_TUJU,
						]);
					}
					dTableBKirim.draw();
		...
		chooseKirim = function( NO_KIRIM, CBG_TUJU ){
...
//////////////////////////////////////////////////////////////////
	...
	// 	{
	// 		window.location ="{{url('/kmterima/delete/'.$header->NO_ID .'/?flagz='.$flagz.'' )}}";
	// 		//return true;
	// 	} 
	// 	return false;
	// }
