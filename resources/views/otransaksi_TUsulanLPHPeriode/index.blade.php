                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="info-box">
                                    ...
                                    <ul class="mb-0">
                                        <li>Klik <strong>Proses Ambil Data</strong> untuk mengambil data LPH periode baru
                                        </li>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#tableData').DataTable({
                ...
                columns: [{
                        ...
                        render: function(data, type, row) {
                            ...
                            return '<input type="checkbox" class="check-item" data-sub="' + row
                                .sub +
            ...
            $(document).on('click', '.btn-print', function() {
                ...
                let url = '/tusulanlphperiode/print?sub=' + sub + '&per=' + per + '&ket=' + ket;
