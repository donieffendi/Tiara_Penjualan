                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control form-control-lg" id="tgl_posting"
                                                    name="tgl_posting" value="{{ date('Y-m-d') }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
        ...
        $(document).ready(function() {
            ...
            $('#btnPosting').on('click', function() {
                ...
                Swal.fire({
                    ...
                    html: 'Posting akhir bulan untuk tanggal <strong>' + moment(tgl).format(
                        'DD-MM-YYYY') + '</strong>?',
                    icon: 'question',
                    ...
                    preConfirm: () => {
                        $('#btnPosting').prop('disabled', true).html(
                    ...
                    $('#btnPosting').prop('disabled', false).html(
                        '<i class="fas fa-check-circle"></i> POSTING');
                    $('#LOADX').hide();
