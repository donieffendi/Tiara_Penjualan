      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <form id="entri" method="POST" action="{{url('ubahklk/posting')}}">
                    @csrf	  
...
<script>
  ...
  $(document).ready(function() {
        ...
        $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('ubahklk/edit?flagz='.$flagz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a');
    });
