...
class TransLainController extends Controller
{
     ...
     */
    public function getTransLain(Request $request)
    {
        return $this->getTlain($request);
    }
     ...
     * Alias method for route compatibility
     */
    public function getDetailTransLain(Request $request)
    {
        return $this->getDetailTlain($request);
    }
