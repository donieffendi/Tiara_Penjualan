...
// ganti 2
class UblController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // ganti 3
        return view('master_ubl.index');
    }


    // ganti 4
    public function getUbl( Request $request )
    {
        // ganti 5
        // $CBG = Auth::user()->CBG;
        ...
        $ubl = DB::SELECT("SELECT a.NO_ID, a.SUB, a.KD_BRG, a.NA_BRG, a.KET_UK, a.KET_KEM, a.BARCODE, a.SUPP, a.HB, a.D1, a.D2,
                                  a.D3, a.LPH_GZ, a.LPH_TD, a.LPH_TM, a.DTR_GZ, a.KD, b.TYPE, a.MIN_TOKO, a.MAX_TOKO, a.MIN_GD, a.MAX_GD
                            FROM brgchd AS a, brgch AS b");

        // ganti 6

        return Datatables::of($ubl)
            ->addIndexColumn()
