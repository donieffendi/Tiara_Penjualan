...
// ganti 2
class PenghaController extends Controller
{
    /**
...
// ganti 3
        return view('master_pengha.index');
    }

// ganti 4
    public function getPengha()
    {
		$pengha = DB::SELECT("SELECT a.NO_ID, b.NA_FILE, a.SUPP, a.SUB, a.NOITEM, c.NAMAS, c.TLP_K, c.GOLONGAN, c.KLK, a.HARGA, a.D1,
                                    a.D2, a.D3, a.KLK1, a.MO1, a.CAT, a.CAT2, a.CAT3, a.PPN, a.TG_MULAI, a.TG_AKHIR, a.TGRB 
                                from supd2chd AS a, supd2ch AS b, sup AS c");

        return Datatables::of($pengha)
                ->addIndexColumn()
