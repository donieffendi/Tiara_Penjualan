...
// ganti 2
class PermaxController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // ganti 3
        return view('master_permax.index');
    }


    // ganti 4
    public function getPermax( Request $request )
    {
        // ganti 5
        // $CBG = Auth::user()->CBG;
        ...
        $permax = DB::SELECT("SELECT a.NO_ID, b.NA_FILE, a.SUB, a.KD_BRG, a.NA_BRG, a.KET_UK, a.TARIK, a.MASA_EXP
                            FROM brgchd AS a, brgch AS b");

        // ganti 6

        return Datatables::of($permax)
            ->addIndexColumn()
