...
// ganti 2
class RehapController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // ganti 3
        return view('master_rehap.index');
    }


    // ganti 4
    public function getRehap( Request $request )
    {
        // ganti 5
        // $CBG = Auth::user()->CBG;
        ...
        $ubl = DB::SELECT("SELECT a.NO_ID, b.NA_FILE, a.SUB, a.TGLPRO, a.KD_BRG, a.NA_BRG, a.KET_UK, a.KET_KEM, a.ALASAN, a.SUPP, 
                                    b.USRNM, a.KET, a.LOC
