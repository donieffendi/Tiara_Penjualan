...
// ganti 2
class PerpnController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // ganti 3
        return view('master_perpn.index');
    }


    // ganti 4
    public function getPerpn( Request $request )
    {
        // ganti 5
        // $CBG = Auth::user()->CBG;
        ...
        $perpn = DB::SELECT("SELECT a.NO_ID, b.NA_FILE, a.SUB, a.KD_BRG, a.NA_BRG, a.KET_UK, a.TGLPRO, a.PPN
                            FROM brgchd AS a, brgch AS b");

        // ganti 6

        return Datatables::of($perpn)
            ->addIndexColumn()
