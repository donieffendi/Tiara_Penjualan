        ...
        return Datatables::of($invoice)
                ...
                ->addColumn('action', function($row) {
					...
					{   
                        ...
                        $url = "'".url("invoice/delete/" . $row->NO_ID )."'";
                        // batas
                        ...
                        $btnPrivilege =
                            '
                                    <a class="dropdown-item" href="invoice/edit/?idx=' . $row->NO_ID . '&tipx=edit";
                    ...
                    $actionBtn =
                        ...
                        <div class="dropdown show" style="text-align: center">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a hidden class="dropdown-item" href="invoice/show/' . $row->NO_ID . '">
