...
class EdcController extends Controller
{
    ...
    public function index() 
    {
        ...
        return view('master_edc.index')->with('cbg', $cbg);
    }

    public function getEdc(Request $request)
    {
        $brg = DB::SELECT("SELECT NO_ID, BANK, KODE, NM_BANK, NOBANK from masbank WHERE BANK<>'' GROUP BY BANK ORDER BY BANK");
                    ...
                    $actionBtn =
                        ...
                        <div class="dropdown show" style="text-align: center">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a hidden class="dropdown-item" href="edc/show/' . $row->NO_ID . '">
    ...
    {
        $brg = DB::SELECT("SELECT NO_ID, KD_EDC from ma_edc");
