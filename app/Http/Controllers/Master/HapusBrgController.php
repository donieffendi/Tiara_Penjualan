...
class HapusBrgController extends Controller
{
    ...
    public function index() {
        ...
        return view('master_hapus_barang.index')->with('cbg', $cbg);
    }

    public function getHBrg(Request $request)
    {
        $cbg = $request->cbg;
        ...
        return Datatables::of($brg)
                ...
                ->addColumn('action', function($row) {
					...
					{   
                        ...
                        $btnPrivilege =
                            '
                                    <a class="dropdown-item" href="hbrg/edit/?idx=' . $row->no_id . '&tipx=edit";
