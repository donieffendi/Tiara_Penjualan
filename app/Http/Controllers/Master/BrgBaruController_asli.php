...
class BrgBaruController extends Controller
{
    ...
    public function index() {
        return view('master_barang_baru.index');
    }

    public function getBrgBaru(Request $request)
    {
        ...
        $sql = "SELECT 
            ...
            LEFT JOIN
                supd2 AS c ON a.KD_BRG = c.KD_BRG
            LEFT JOIN
                brgdt AS d ON a.KD_BRG = d.KD_BRG
            WHERE 1=1";
        $bindings = [];
        ...
        return Datatables::of($brg)
                ...
                ->addColumn('action', function($row) {
					...
					{   
                        ...
                        $btnPrivilege =
                            '
                                    <a class="dropdown-item" href="brg-baru/edit/?idx=' . $row->NO_ID . '&tipx=edit";
                    ...
                    $actionBtn =
                        ...
                        <div class="dropdown show" style="text-align: center">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a hidden class="dropdown-item" href="brg-baru/show/' . $row->NO_ID . '">
